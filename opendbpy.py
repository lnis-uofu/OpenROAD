...
class Point(object):
    ...
    def __ge__(self, p):
        return _opendbpy.Point___ge__(self, p)
    ...
    def addX(self, x):
        return _opendbpy.Point_addX(self, x)

    def addY(self, y):
        return _opendbpy.Point_addY(self, y)
    ...
    def x(self):
        return _opendbpy.Point_x(self)

    def y(self):
        return _opendbpy.Point_y(self)
...
class Rect(object):
    ...
    def xCenter(self):
        return _opendbpy.Rect_xCenter(self)

    def yCenter(self):
        return _opendbpy.Rect_yCenter(self)
    ...
    def closestPtInside(self, pt):
        return _opendbpy.Rect_closestPtInside(self, pt)

    def merge(self, *args):
        return _opendbpy.Rect_merge(self, *args)

    def bloat(self, margin, result):
        return _opendbpy.Rect_bloat(self, margin, result)
...
class Points(object):
    ...
    def iterator(self):
        return _opendbpy.Points_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _opendbpy.Points___nonzero__(self)

    def __bool__(self):
        return _opendbpy.Points___bool__(self)

    def __len__(self):
        return _opendbpy.Points___len__(self)

    def __getslice__(self, i, j):
        return _opendbpy.Points___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _opendbpy.Points___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _opendbpy.Points___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _opendbpy.Points___delitem__(self, *args)

    def __getitem__(self, *args):
        return _opendbpy.Points___getitem__(self, *args)

    def __setitem__(self, *args):
        return _opendbpy.Points___setitem__(self, *args)

    def pop(self):
        return _opendbpy.Points_pop(self)

    def append(self, x):
        return _opendbpy.Points_append(self, x)

    def empty(self):
        return _opendbpy.Points_empty(self)

    def size(self):
        return _opendbpy.Points_size(self)

    def swap(self, v):
        return _opendbpy.Points_swap(self, v)

    def begin(self):
        return _opendbpy.Points_begin(self)

    def end(self):
        return _opendbpy.Points_end(self)

    def rbegin(self):
        return _opendbpy.Points_rbegin(self)

    def rend(self):
        return _opendbpy.Points_rend(self)

    def clear(self):
        return _opendbpy.Points_clear(self)

    def get_allocator(self):
        return _opendbpy.Points_get_allocator(self)

    def pop_back(self):
        return _opendbpy.Points_pop_back(self)

    def erase(self, *args):
        return _opendbpy.Points_erase(self, *args)

    def __init__(self, *args):
        _opendbpy.Points_swiginit(self, _opendbpy.new_Points(*args))

    def push_back(self, x):
        return _opendbpy.Points_push_back(self, x)

    def front(self):
        return _opendbpy.Points_front(self)

    def back(self):
        return _opendbpy.Points_back(self)

    def assign(self, n, x):
        return _opendbpy.Points_assign(self, n, x)

    def resize(self, *args):
        return _opendbpy.Points_resize(self, *args)

    def insert(self, *args):
        return _opendbpy.Points_insert(self, *args)

    def reserve(self, n):
        return _opendbpy.Points_reserve(self, n)

    def capacity(self):
        return _opendbpy.Points_capacity(self)
    __swig_destroy__ = _opendbpy.delete_Points

# Register Points in _opendbpy:
_opendbpy.Points_swigregister(Points)
class Rects(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _opendbpy.Rects_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _opendbpy.Rects___nonzero__(self)

    def __bool__(self):
        return _opendbpy.Rects___bool__(self)

    def __len__(self):
        return _opendbpy.Rects___len__(self)

    def __getslice__(self, i, j):
        return _opendbpy.Rects___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _opendbpy.Rects___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _opendbpy.Rects___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _opendbpy.Rects___delitem__(self, *args)

    def __getitem__(self, *args):
        return _opendbpy.Rects___getitem__(self, *args)

    def __setitem__(self, *args):
        return _opendbpy.Rects___setitem__(self, *args)

    def pop(self):
        return _opendbpy.Rects_pop(self)

    def append(self, x):
        return _opendbpy.Rects_append(self, x)

    def empty(self):
        return _opendbpy.Rects_empty(self)

    def size(self):
        return _opendbpy.Rects_size(self)

    def swap(self, v):
        return _opendbpy.Rects_swap(self, v)

    def begin(self):
        return _opendbpy.Rects_begin(self)

    def end(self):
        return _opendbpy.Rects_end(self)

    def rbegin(self):
        return _opendbpy.Rects_rbegin(self)

    def rend(self):
        return _opendbpy.Rects_rend(self)

    def clear(self):
        return _opendbpy.Rects_clear(self)

    def get_allocator(self):
        return _opendbpy.Rects_get_allocator(self)

    def pop_back(self):
        return _opendbpy.Rects_pop_back(self)

    def erase(self, *args):
        return _opendbpy.Rects_erase(self, *args)

    def __init__(self, *args):
        _opendbpy.Rects_swiginit(self, _opendbpy.new_Rects(*args))

    def push_back(self, x):
        return _opendbpy.Rects_push_back(self, x)

    def front(self):
        return _opendbpy.Rects_front(self)

    def back(self):
        return _opendbpy.Rects_back(self)

    def assign(self, n, x):
        return _opendbpy.Rects_assign(self, n, x)

    def resize(self, *args):
        return _opendbpy.Rects_resize(self, *args)

    def insert(self, *args):
        return _opendbpy.Rects_insert(self, *args)

    def reserve(self, n):
        return _opendbpy.Rects_reserve(self, n)

    def capacity(self):
        return _opendbpy.Rects_capacity(self)
    __swig_destroy__ = _opendbpy.delete_Rects

# Register Rects in _opendbpy:
_opendbpy.Rects_swigregister(Rects)
class Polygon90Set(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _opendbpy.Polygon90Set_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _opendbpy.Polygon90Set___nonzero__(self)

    def __bool__(self):
        return _opendbpy.Polygon90Set___bool__(self)

    def __len__(self):
        return _opendbpy.Polygon90Set___len__(self)

    def __getslice__(self, i, j):
        return _opendbpy.Polygon90Set___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _opendbpy.Polygon90Set___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _opendbpy.Polygon90Set___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _opendbpy.Polygon90Set___delitem__(self, *args)

    def __getitem__(self, *args):
        return _opendbpy.Polygon90Set___getitem__(self, *args)

    def __setitem__(self, *args):
        return _opendbpy.Polygon90Set___setitem__(self, *args)

    def pop(self):
        return _opendbpy.Polygon90Set_pop(self)

    def append(self, x):
        return _opendbpy.Polygon90Set_append(self, x)

    def empty(self):
        return _opendbpy.Polygon90Set_empty(self)

    def size(self):
        return _opendbpy.Polygon90Set_size(self)

    def swap(self, v):
        return _opendbpy.Polygon90Set_swap(self, v)

    def begin(self):
        return _opendbpy.Polygon90Set_begin(self)

    def end(self):
        return _opendbpy.Polygon90Set_end(self)

    def rbegin(self):
        return _opendbpy.Polygon90Set_rbegin(self)

    def rend(self):
        return _opendbpy.Polygon90Set_rend(self)

    def clear(self):
        return _opendbpy.Polygon90Set_clear(self)

    def get_allocator(self):
        return _opendbpy.Polygon90Set_get_allocator(self)

    def pop_back(self):
        return _opendbpy.Polygon90Set_pop_back(self)

    def erase(self, *args):
        return _opendbpy.Polygon90Set_erase(self, *args)

    def __init__(self, *args):
        _opendbpy.Polygon90Set_swiginit(self, _opendbpy.new_Polygon90Set(*args))

    def push_back(self, x):
        return _opendbpy.Polygon90Set_push_back(self, x)

    def front(self):
        return _opendbpy.Polygon90Set_front(self)

    def back(self):
        return _opendbpy.Polygon90Set_back(self)

    def assign(self, n, x):
        return _opendbpy.Polygon90Set_assign(self, n, x)

    def resize(self, *args):
        return _opendbpy.Polygon90Set_resize(self, *args)

    def insert(self, *args):
        return _opendbpy.Polygon90Set_insert(self, *args)

    def reserve(self, n):
        return _opendbpy.Polygon90Set_reserve(self, n)

    def capacity(self):
        return _opendbpy.Polygon90Set_capacity(self)
    __swig_destroy__ = _opendbpy.delete_Polygon90Set

# Register Polygon90Set in _opendbpy:
_opendbpy.Polygon90Set_swigregister(Polygon90Set)
class Polygon90Sets(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _opendbpy.Polygon90Sets_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _opendbpy.Polygon90Sets___nonzero__(self)

    def __bool__(self):
        return _opendbpy.Polygon90Sets___bool__(self)

    def __len__(self):
        return _opendbpy.Polygon90Sets___len__(self)

    def __getslice__(self, i, j):
        return _opendbpy.Polygon90Sets___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _opendbpy.Polygon90Sets___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _opendbpy.Polygon90Sets___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _opendbpy.Polygon90Sets___delitem__(self, *args)

    def __getitem__(self, *args):
        return _opendbpy.Polygon90Sets___getitem__(self, *args)

    def __setitem__(self, *args):
        return _opendbpy.Polygon90Sets___setitem__(self, *args)

    def pop(self):
        return _opendbpy.Polygon90Sets_pop(self)

    def append(self, x):
        return _opendbpy.Polygon90Sets_append(self, x)

    def empty(self):
        return _opendbpy.Polygon90Sets_empty(self)

    def size(self):
        return _opendbpy.Polygon90Sets_size(self)

    def swap(self, v):
        return _opendbpy.Polygon90Sets_swap(self, v)

    def begin(self):
        return _opendbpy.Polygon90Sets_begin(self)

    def end(self):
        return _opendbpy.Polygon90Sets_end(self)

    def rbegin(self):
        return _opendbpy.Polygon90Sets_rbegin(self)

    def rend(self):
        return _opendbpy.Polygon90Sets_rend(self)

    def clear(self):
        return _opendbpy.Polygon90Sets_clear(self)

    def get_allocator(self):
        return _opendbpy.Polygon90Sets_get_allocator(self)

    def pop_back(self):
        return _opendbpy.Polygon90Sets_pop_back(self)

    def erase(self, *args):
        return _opendbpy.Polygon90Sets_erase(self, *args)

    def __init__(self, *args):
        _opendbpy.Polygon90Sets_swiginit(self, _opendbpy.new_Polygon90Sets(*args))

    def push_back(self, x):
        return _opendbpy.Polygon90Sets_push_back(self, x)

    def front(self):
        return _opendbpy.Polygon90Sets_front(self)

    def back(self):
        return _opendbpy.Polygon90Sets_back(self)

    def assign(self, n, x):
        return _opendbpy.Polygon90Sets_assign(self, n, x)

    def resize(self, *args):
        return _opendbpy.Polygon90Sets_resize(self, *args)

    def insert(self, *args):
        return _opendbpy.Polygon90Sets_insert(self, *args)

    def reserve(self, n):
        return _opendbpy.Polygon90Sets_reserve(self, n)

    def capacity(self):
        return _opendbpy.Polygon90Sets_capacity(self)
    __swig_destroy__ = _opendbpy.delete_Polygon90Sets

# Register Polygon90Sets in _opendbpy:
_opendbpy.Polygon90Sets_swigregister(Polygon90Sets)

def newSetFromRect(xLo, yLo, xHi, yHi):
    return _opendbpy.newSetFromRect(xLo, yLo, xHi, yHi)

def getPoints(polygon):
    return _opendbpy.getPoints(polygon)

def getPolygons(set):
    return _opendbpy.getPolygons(set)

def getRectangles(set):
    return _opendbpy.getRectangles(set)

def bloatSet(*args):
    return _opendbpy.bloatSet(*args)

def shrinkSet(*args):
    return _opendbpy.shrinkSet(*args)

def andSet(set1, set2):
    return _opendbpy.andSet(set1, set2)

def orSet(set1, set2):
    return _opendbpy.orSet(set1, set2)

def orSets(sets):
    return _opendbpy.orSets(sets)

def subtractSet(set1, set2):
    return _opendbpy.subtractSet(set1, set2)
...
class dbBox(object):
    ...
    def getViaXY(self, *args):
        return _opendbpy.dbBox_getViaXY(self, *args)
...
class dbSBox(dbBox):
    ...
    @staticmethod
    def destroy(box):
        return _opendbpy.dbSBox_destroy(box)
...
class dbBlock(object):
    ...
    def getPowerDomains(self):
        return _opendbpy.dbBlock_getPowerDomains(self)

    def getLogicPorts(self):
        return _opendbpy.dbBlock_getLogicPorts(self)

    def getPowerSwitches(self):
        return _opendbpy.dbBlock_getPowerSwitches(self)

    def getIsolations(self):
        return _opendbpy.dbBlock_getIsolations(self)

    def getGroups(self):
        return _opendbpy.dbBlock_getGroups(self)

    def getAccessPoints(self):
        return _opendbpy.dbBlock_getAccessPoints(self)

    def getGlobalConnects(self):
        return _opendbpy.dbBlock_getGlobalConnects(self)

    def globalConnect(self, *args):
        return _opendbpy.dbBlock_globalConnect(self, *args)

    def addGlobalConnect(self, region, instPattern, pinPattern, net, do_connect):
        return _opendbpy.dbBlock_addGlobalConnect(self, region, instPattern, pinPattern, net, do_connect)

    def reportGlobalConnect(self):
        return _opendbpy.dbBlock_reportGlobalConnect(self)

    def clearGlobalConnect(self):
        return _opendbpy.dbBlock_clearGlobalConnect(self)
    ...
    def findPowerDomain(self, name):
        return _opendbpy.dbBlock_findPowerDomain(self, name)

    def findLogicPort(self, name):
        return _opendbpy.dbBlock_findLogicPort(self, name)

    def findPowerSwitch(self, name):
        return _opendbpy.dbBlock_findPowerSwitch(self, name)

    def findIsolation(self, name):
        return _opendbpy.dbBlock_findIsolation(self, name)
    ...
    def saveLef(self, filename, bloat_factor, bloat_occupied_layers):
        return _opendbpy.dbBlock_saveLef(self, filename, bloat_factor, bloat_occupied_layers)
    ...
    def writeGuides(self, filename):
        return _opendbpy.dbBlock_writeGuides(self, filename)
    ...
    def getWireUpdatedNets(self, nets):
        return _opendbpy.dbBlock_getWireUpdatedNets(self, nets)
...
class dbBPin(object):
    ...
    def getAccessPoints(self):
        return _opendbpy.dbBPin_getAccessPoints(self)
...
class dbNet(object):
    ...
    def getTermBBox(self):
        return _opendbpy.dbNet_getTermBBox(self)
    ...
    def getGuides(self):
        return _opendbpy.dbNet_getGuides(self)

    def clearGuides(self):
        return _opendbpy.dbNet_clearGuides(self)
...
class dbInst(object):
    ...
    def getLocation(self, *args):
        return _opendbpy.dbInst_getLocation(self, *args)
    ...
    def setPinAccessIdx(self, idx):
        return _opendbpy.dbInst_setPinAccessIdx(self, idx)

    def getPinAccessIdx(self):
        return _opendbpy.dbInst_getPinAccessIdx(self)
...
class dbITerm(object):
    ...
    def connect(self, net):
        return _opendbpy.dbITerm_connect(self, net)

    def disconnect(self):
        return _opendbpy.dbITerm_disconnect(self)

    def getAvgXY(self):
        return _opendbpy.dbITerm_getAvgXY(self)

    def getGeometries(self):
        return _opendbpy.dbITerm_getGeometries(self)

    def setAccessPoint(self, pin, ap):
        return _opendbpy.dbITerm_setAccessPoint(self, pin, ap)

    def getPrefAccessPoints(self):
        return _opendbpy.dbITerm_getPrefAccessPoints(self)

    def getAccessPoints(self):
        return _opendbpy.dbITerm_getAccessPoints(self)
...
class dbVia(object):
    ...
    def setDefault(self, arg2):
        return _opendbpy.dbVia_setDefault(self, arg2)

    def isDefault(self):
        return _opendbpy.dbVia_isDefault(self)
...
class dbTrackGrid(object):
    ...
    def getGridX(self):
        return _opendbpy.dbTrackGrid_getGridX(self)

    def getGridY(self):
        return _opendbpy.dbTrackGrid_getGridY(self)
    ...
    def getGridPatternX(self, i):
        return _opendbpy.dbTrackGrid_getGridPatternX(self, i)

    def getGridPatternY(self, i):
        return _opendbpy.dbTrackGrid_getGridPatternY(self, i)
...
class dbRegion(object):
    ...
    def removeGroup(self, group):
        return _opendbpy.dbRegion_removeGroup(self, group)

    def addGroup(self, group):
        return _opendbpy.dbRegion_addGroup(self, group)

    def getGroups(self):
        return _opendbpy.dbRegion_getGroups(self)
    ...
    def create(block, name):
        return _opendbpy.dbRegion_create(block, name)
...
class dbMaster(object):
    ...
    def isCover(self):
        return _opendbpy.dbMaster_isCover(self)
...
class dbMTerm(object):
    ...
    def getShape(self):
        return _opendbpy.dbMTerm_getShape(self)
...
class dbMPin(object):
    ...
    def getPinAccess(self):
        return _opendbpy.dbMPin_getPinAccess(self)
...
class dbTech(object):
    ...
    def getMetalWidthViaMap(self):
        return _opendbpy.dbTech_getMetalWidthViaMap(self)
...
class dbTechLayerSpacingRule(object):
    ...
    def setSpacingNotchLengthValid(self, val):
        return _opendbpy.dbTechLayerSpacingRule_setSpacingNotchLengthValid(self, val)

    def setSpacingEndOfNotchWidthValid(self, val):
        return _opendbpy.dbTechLayerSpacingRule_setSpacingEndOfNotchWidthValid(self, val)

    def hasSpacingNotchLength(self):
        return _opendbpy.dbTechLayerSpacingRule_hasSpacingNotchLength(self)

    def hasSpacingEndOfNotchWidth(self):
        return _opendbpy.dbTechLayerSpacingRule_hasSpacingEndOfNotchWidth(self)

    def hasRange(self):
        return _opendbpy.dbTechLayerSpacingRule_hasRange(self)

    def hasLengthThreshold(self):
        return _opendbpy.dbTechLayerSpacingRule_hasLengthThreshold(self)
    ...
    def setSameNetPgOnly(self, pgonly):
        return _opendbpy.dbTechLayerSpacingRule_setSameNetPgOnly(self, pgonly)

    def getSameNetPgOnly(self):
        return _opendbpy.dbTechLayerSpacingRule_getSameNetPgOnly(self)
...
class dbTechLayer(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    NONE = _opendbpy.dbTechLayer_NONE
    NWELL = _opendbpy.dbTechLayer_NWELL
    PWELL = _opendbpy.dbTechLayer_PWELL
    ABOVEDIEEDGE = _opendbpy.dbTechLayer_ABOVEDIEEDGE
    BELOWDIEEDGE = _opendbpy.dbTechLayer_BELOWDIEEDGE
    DIFFUSION = _opendbpy.dbTechLayer_DIFFUSION
    TRIMPOLY = _opendbpy.dbTechLayer_TRIMPOLY
    MIMCAP = _opendbpy.dbTechLayer_MIMCAP
    STACKEDMIMCAP = _opendbpy.dbTechLayer_STACKEDMIMCAP
    TSVMETAL = _opendbpy.dbTechLayer_TSVMETAL
    TSV = _opendbpy.dbTechLayer_TSV
    PASSIVATION = _opendbpy.dbTechLayer_PASSIVATION
    HIGHR = _opendbpy.dbTechLayer_HIGHR
    TRIMMETAL = _opendbpy.dbTechLayer_TRIMMETAL
    REGION = _opendbpy.dbTechLayer_REGION
    MEOL = _opendbpy.dbTechLayer_MEOL
    WELLDISTANCE = _opendbpy.dbTechLayer_WELLDISTANCE
    CPODE = _opendbpy.dbTechLayer_CPODE
    PADMETAL = _opendbpy.dbTechLayer_PADMETAL
    POLYROUTING = _opendbpy.dbTechLayer_POLYROUTING

    def setWrongWayWidth(self, wrong_way_width):
        return _opendbpy.dbTechLayer_setWrongWayWidth(self, wrong_way_width)

    def getWrongWayWidth(self):
        return _opendbpy.dbTechLayer_getWrongWayWidth(self)

    def getTechLayerCutClassRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCutClassRules(self)

    def findTechLayerCutClassRule(self, name):
        return _opendbpy.dbTechLayer_findTechLayerCutClassRule(self, name)

    def getTechLayerSpacingEolRules(self):
        return _opendbpy.dbTechLayer_getTechLayerSpacingEolRules(self)

    def getTechLayerCutSpacingRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCutSpacingRules(self)

    def getTechLayerMinStepRules(self):
        return _opendbpy.dbTechLayer_getTechLayerMinStepRules(self)

    def getTechLayerCornerSpacingRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCornerSpacingRules(self)

    def getTechLayerSpacingTablePrlRules(self):
        return _opendbpy.dbTechLayer_getTechLayerSpacingTablePrlRules(self)

    def getTechLayerCutSpacingTableOrthRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCutSpacingTableOrthRules(self)

    def getTechLayerCutSpacingTableDefRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCutSpacingTableDefRules(self)

    def getTechLayerCutEnclosureRules(self):
        return _opendbpy.dbTechLayer_getTechLayerCutEnclosureRules(self)

    def getTechLayerEolExtensionRules(self):
        return _opendbpy.dbTechLayer_getTechLayerEolExtensionRules(self)

    def getTechLayerArraySpacingRules(self):
        return _opendbpy.dbTechLayer_getTechLayerArraySpacingRules(self)

    def getTechLayerEolKeepOutRules(self):
        return _opendbpy.dbTechLayer_getTechLayerEolKeepOutRules(self)

    def getTechLayerWidthTableRules(self):
        return _opendbpy.dbTechLayer_getTechLayerWidthTableRules(self)

    def getTechLayerMinCutRules(self):
        return _opendbpy.dbTechLayer_getTechLayerMinCutRules(self)

    def getTechLayerAreaRules(self):
        return _opendbpy.dbTechLayer_getTechLayerAreaRules(self)

    def setRectOnly(self, rect_only):
        return _opendbpy.dbTechLayer_setRectOnly(self, rect_only)

    def isRectOnly(self):
        return _opendbpy.dbTechLayer_isRectOnly(self)

    def setRightWayOnGridOnly(self, right_way_on_grid_only):
        return _opendbpy.dbTechLayer_setRightWayOnGridOnly(self, right_way_on_grid_only)

    def isRightWayOnGridOnly(self):
        return _opendbpy.dbTechLayer_isRightWayOnGridOnly(self)

    def setRightWayOnGridOnlyCheckMask(self, right_way_on_grid_only_check_mask):
        return _opendbpy.dbTechLayer_setRightWayOnGridOnlyCheckMask(self, right_way_on_grid_only_check_mask)

    def isRightWayOnGridOnlyCheckMask(self):
        return _opendbpy.dbTechLayer_isRightWayOnGridOnlyCheckMask(self)

    def setRectOnlyExceptNonCorePins(self, rect_only_except_non_core_pins):
        return _opendbpy.dbTechLayer_setRectOnlyExceptNonCorePins(self, rect_only_except_non_core_pins)

    def isRectOnlyExceptNonCorePins(self):
        return _opendbpy.dbTechLayer_isRectOnlyExceptNonCorePins(self)

    def findV55Spacing(self, width, prl):
        return _opendbpy.dbTechLayer_findV55Spacing(self, width, prl)

    def findTwSpacing(self, width1, width2, prl):
        return _opendbpy.dbTechLayer_findTwSpacing(self, width1, width2, prl)

    def setLef58Type(self, type):
        return _opendbpy.dbTechLayer_setLef58Type(self, type)

    def getLef58Type(self):
        return _opendbpy.dbTechLayer_getLef58Type(self)

    def getLef58TypeString(self):
        return _opendbpy.dbTechLayer_getLef58TypeString(self)
    ...
    def getNumMasks(self):
        return _opendbpy.dbTechLayer_getNumMasks(self)

    def setNumMasks(self, number):
        return _opendbpy.dbTechLayer_setNumMasks(self, number)
    ...
    def getV54SpacingRules(self):
        return _opendbpy.dbTechLayer_getV54SpacingRules(self)
    ...
    def getV55SpacingWidthsAndLengths(self, width_idx, length_idx):
        return _opendbpy.dbTechLayer_getV55SpacingWidthsAndLengths(self, width_idx, length_idx)
    ...
    def getV55InfluenceRules(self):
        return _opendbpy.dbTechLayer_getV55InfluenceRules(self)
...
class dbTechLayerSpacingEolRule(object):
    ...
    def setOppositeWidth(self, opposite_width):
        return _opendbpy.dbTechLayerSpacingEolRule_setOppositeWidth(self, opposite_width)
    ...
    def setEolWithin(self, eol_within):
        return _opendbpy.dbTechLayerSpacingEolRule_setEolWithin(self, eol_within)
    ...
    def setWrongDirWithin(self, wrong_dir_within):
        return _opendbpy.dbTechLayerSpacingEolRule_setWrongDirWithin(self, wrong_dir_within)
    ...
    def setExactWidth(self, exact_width):
        return _opendbpy.dbTechLayerSpacingEolRule_setExactWidth(self, exact_width)

    def getExactWidth(self):
        return _opendbpy.dbTechLayerSpacingEolRule_getExactWidth(self)

    def setOtherWidth(self, other_width):
        return _opendbpy.dbTechLayerSpacingEolRule_setOtherWidth(self, other_width)
    ...
    def setEnclosureEndWidth(self, enclosure_end_width):
        return _opendbpy.dbTechLayerSpacingEolRule_setEnclosureEndWidth(self, enclosure_end_width)
    ...
    def setEnclosureEndWithin(self, enclosure_end_within):
        return _opendbpy.dbTechLayerSpacingEolRule_setEnclosureEndWithin(self, enclosure_end_within)
    ...
    def setEndPrlSpace(self, end_prl_space):
        return _opendbpy.dbTechLayerSpacingEolRule_setEndPrlSpace(self, end_prl_space)

    def getEndPrlSpace(self):
        return _opendbpy.dbTechLayerSpacingEolRule_getEndPrlSpace(self)

    def setEndPrl(self, end_prl):
        return _opendbpy.dbTechLayerSpacingEolRule_setEndPrl(self, end_prl)

    def getEndPrl(self):
        return _opendbpy.dbTechLayerSpacingEolRule_getEndPrl(self)

    def setEndToEndSpace(self, end_to_end_space):
        return _opendbpy.dbTechLayerSpacingEolRule_setEndToEndSpace(self, end_to_end_space)
    ...
    def setOneCutSpace(self, one_cut_space):
        return _opendbpy.dbTechLayerSpacingEolRule_setOneCutSpace(self, one_cut_space)
    ...
    def setTwoCutSpace(self, two_cut_space):
        return _opendbpy.dbTechLayerSpacingEolRule_setTwoCutSpace(self, two_cut_space)

    def getTwoCutSpace(self):
        return _opendbpy.dbTechLayerSpacingEolRule_getTwoCutSpace(self)

    def setExtension(self, extension):
        return _opendbpy.dbTechLayerSpacingEolRule_setExtension(self, extension)

    def getExtension(self):
        return _opendbpy.dbTechLayerSpacingEolRule_getExtension(self)

    def setWrongDirExtension(self, wrong_dir_extension):
        return _opendbpy.dbTechLayerSpacingEolRule_setWrongDirExtension(self, wrong_dir_extension)
    ...
    def setOtherEndWidth(self, other_end_width):
        return _opendbpy.dbTechLayerSpacingEolRule_setOtherEndWidth(self, other_end_width)
    ...
    def setEncloseDist(self, enclose_dist):
        return _opendbpy.dbTechLayerSpacingEolRule_setEncloseDist(self, enclose_dist)
    ...
    def setCutToMetalSpace(self, cut_to_metal_space):
        return _opendbpy.dbTechLayerSpacingEolRule_setCutToMetalSpace(self, cut_to_metal_space)
    ...
    def setMinAdjLength(self, min_adj_length):
        return _opendbpy.dbTechLayerSpacingEolRule_setMinAdjLength(self, min_adj_length)
    ...
    def setMinAdjLength1(self, min_adj_length1):
        return _opendbpy.dbTechLayerSpacingEolRule_setMinAdjLength1(self, min_adj_length1)
    ...
    def setMinAdjLength2(self, min_adj_length2):
        return _opendbpy.dbTechLayerSpacingEolRule_setMinAdjLength2(self, min_adj_length2)
    ...
    def setNotchLength(self, notch_length):
        return _opendbpy.dbTechLayerSpacingEolRule_setNotchLength(self, notch_length)
    ...
    def setExactWidthValid(self, exact_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setExactWidthValid(self, exact_width_valid)
    ...
    def setWrongDirSpacingValid(self, wrong_dir_spacing_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWrongDirSpacingValid(self, wrong_dir_spacing_valid)
    ...
    def setOppositeWidthValid(self, opposite_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setOppositeWidthValid(self, opposite_width_valid)
    ...
    def setWithinValid(self, within_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWithinValid(self, within_valid)
    ...
    def setWrongDirWithinValid(self, wrong_dir_within_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWrongDirWithinValid(self, wrong_dir_within_valid)
    ...
    def setSameMaskValid(self, same_mask_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setSameMaskValid(self, same_mask_valid)
    ...
    def setExceptExactWidthValid(self, except_exact_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setExceptExactWidthValid(self, except_exact_width_valid)
    ...
    def setFillConcaveCornerValid(self, fill_concave_corner_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setFillConcaveCornerValid(self, fill_concave_corner_valid)
    ...
    def setWithcutValid(self, withcut_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWithcutValid(self, withcut_valid)
    ...
    def setCutClassValid(self, cut_class_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setCutClassValid(self, cut_class_valid)
    ...
    def setWithCutAboveValid(self, with_cut_above_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWithCutAboveValid(self, with_cut_above_valid)
    ...
    def setEnclosureEndValid(self, enclosure_end_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEnclosureEndValid(self, enclosure_end_valid)
    ...
    def setEnclosureEndWithinValid(self, enclosure_end_within_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEnclosureEndWithinValid(self, enclosure_end_within_valid)
    ...
    def setEndPrlSpacingValid(self, end_prl_spacing_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEndPrlSpacingValid(self, end_prl_spacing_valid)
    ...
    def setPrlValid(self, prl_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setPrlValid(self, prl_valid)

    def isPrlValid(self):
        return _opendbpy.dbTechLayerSpacingEolRule_isPrlValid(self)

    def setEndToEndValid(self, end_to_end_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEndToEndValid(self, end_to_end_valid)
    ...
    def setCutSpacesValid(self, cut_spaces_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setCutSpacesValid(self, cut_spaces_valid)
    ...
    def setExtensionValid(self, extension_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setExtensionValid(self, extension_valid)
    ...
    def setWrongDirExtensionValid(self, wrong_dir_extension_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setWrongDirExtensionValid(self, wrong_dir_extension_valid)
    ...
    def setOtherEndWidthValid(self, other_end_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setOtherEndWidthValid(self, other_end_width_valid)
    ...
    def setMaxLengthValid(self, max_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setMaxLengthValid(self, max_length_valid)
    ...
    def setMinLengthValid(self, min_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setMinLengthValid(self, min_length_valid)
    ...
    def setTwoSidesValid(self, two_sides_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setTwoSidesValid(self, two_sides_valid)
    ...
    def setEqualRectWidthValid(self, equal_rect_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEqualRectWidthValid(self, equal_rect_width_valid)
    ...
    def setParallelEdgeValid(self, parallel_edge_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setParallelEdgeValid(self, parallel_edge_valid)
    ...
    def setSubtractEolWidthValid(self, subtract_eol_width_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setSubtractEolWidthValid(self, subtract_eol_width_valid)
    ...
    def setParPrlValid(self, par_prl_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setParPrlValid(self, par_prl_valid)
    ...
    def setParMinLengthValid(self, par_min_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setParMinLengthValid(self, par_min_length_valid)
    ...
    def setTwoEdgesValid(self, two_edges_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setTwoEdgesValid(self, two_edges_valid)
    ...
    def setSameMetalValid(self, same_metal_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setSameMetalValid(self, same_metal_valid)
    ...
    def setNonEolCornerOnlyValid(self, non_eol_corner_only_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setNonEolCornerOnlyValid(self, non_eol_corner_only_valid)
    ...
    def setParallelSameMaskValid(self, parallel_same_mask_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setParallelSameMaskValid(self, parallel_same_mask_valid)
    ...
    def setEncloseCutValid(self, enclose_cut_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setEncloseCutValid(self, enclose_cut_valid)
    ...
    def setBelowValid(self, below_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setBelowValid(self, below_valid)

    def isBelowValid(self):
        return _opendbpy.dbTechLayerSpacingEolRule_isBelowValid(self)

    def setAboveValid(self, above_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setAboveValid(self, above_valid)
    ...
    def setCutSpacingValid(self, cut_spacing_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setCutSpacingValid(self, cut_spacing_valid)
    ...
    def setAllCutsValid(self, all_cuts_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setAllCutsValid(self, all_cuts_valid)
    ...
    def setToConcaveCornerValid(self, to_concave_corner_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setToConcaveCornerValid(self, to_concave_corner_valid)
    ...
    def setMinAdjacentLengthValid(self, min_adjacent_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setMinAdjacentLengthValid(self, min_adjacent_length_valid)
    ...
    def setTwoMinAdjLengthValid(self, two_min_adj_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setTwoMinAdjLengthValid(self, two_min_adj_length_valid)
    ...
    def setToNotchLengthValid(self, to_notch_length_valid):
        return _opendbpy.dbTechLayerSpacingEolRule_setToNotchLengthValid(self, to_notch_length_valid)
    ...
    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerSpacingEolRule_destroy(rule)
...
class dbTechLayerMinStepRule(object):
    ...
    def setMinStepLength(self, min_step_length):
        return _opendbpy.dbTechLayerMinStepRule_setMinStepLength(self, min_step_length)

    def getMinStepLength(self):
        return _opendbpy.dbTechLayerMinStepRule_getMinStepLength(self)

    def setMaxEdges(self, max_edges):
        return _opendbpy.dbTechLayerMinStepRule_setMaxEdges(self, max_edges)

    def getMaxEdges(self):
        return _opendbpy.dbTechLayerMinStepRule_getMaxEdges(self)

    def setMinAdjLength1(self, min_adj_length1):
        return _opendbpy.dbTechLayerMinStepRule_setMinAdjLength1(self, min_adj_length1)

    def getMinAdjLength1(self):
        return _opendbpy.dbTechLayerMinStepRule_getMinAdjLength1(self)

    def setMinAdjLength2(self, min_adj_length2):
        return _opendbpy.dbTechLayerMinStepRule_setMinAdjLength2(self, min_adj_length2)

    def getMinAdjLength2(self):
        return _opendbpy.dbTechLayerMinStepRule_getMinAdjLength2(self)

    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerMinStepRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerMinStepRule_getEolWidth(self)

    def setMinBetweenLength(self, min_between_length):
        return _opendbpy.dbTechLayerMinStepRule_setMinBetweenLength(self, min_between_length)

    def getMinBetweenLength(self):
        return _opendbpy.dbTechLayerMinStepRule_getMinBetweenLength(self)

    def setMaxEdgesValid(self, max_edges_valid):
        return _opendbpy.dbTechLayerMinStepRule_setMaxEdgesValid(self, max_edges_valid)

    def isMaxEdgesValid(self):
        return _opendbpy.dbTechLayerMinStepRule_isMaxEdgesValid(self)

    def setMinAdjLength1Valid(self, min_adj_length1_valid):
        return _opendbpy.dbTechLayerMinStepRule_setMinAdjLength1Valid(self, min_adj_length1_valid)

    def isMinAdjLength1Valid(self):
        return _opendbpy.dbTechLayerMinStepRule_isMinAdjLength1Valid(self)

    def setNoBetweenEol(self, no_between_eol):
        return _opendbpy.dbTechLayerMinStepRule_setNoBetweenEol(self, no_between_eol)

    def isNoBetweenEol(self):
        return _opendbpy.dbTechLayerMinStepRule_isNoBetweenEol(self)

    def setMinAdjLength2Valid(self, min_adj_length2_valid):
        return _opendbpy.dbTechLayerMinStepRule_setMinAdjLength2Valid(self, min_adj_length2_valid)

    def isMinAdjLength2Valid(self):
        return _opendbpy.dbTechLayerMinStepRule_isMinAdjLength2Valid(self)

    def setConvexCorner(self, convex_corner):
        return _opendbpy.dbTechLayerMinStepRule_setConvexCorner(self, convex_corner)

    def isConvexCorner(self):
        return _opendbpy.dbTechLayerMinStepRule_isConvexCorner(self)

    def setMinBetweenLengthValid(self, min_between_length_valid):
        return _opendbpy.dbTechLayerMinStepRule_setMinBetweenLengthValid(self, min_between_length_valid)

    def isMinBetweenLengthValid(self):
        return _opendbpy.dbTechLayerMinStepRule_isMinBetweenLengthValid(self)

    def setExceptSameCorners(self, except_same_corners):
        return _opendbpy.dbTechLayerMinStepRule_setExceptSameCorners(self, except_same_corners)

    def isExceptSameCorners(self):
        return _opendbpy.dbTechLayerMinStepRule_isExceptSameCorners(self)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerMinStepRule_create(layer)

    @staticmethod
    def getTechLayerMinStepRule(inly, dbid):
        return _opendbpy.dbTechLayerMinStepRule_getTechLayerMinStepRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerMinStepRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerMinStepRule_swiginit(self, _opendbpy.new_dbTechLayerMinStepRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerMinStepRule

# Register dbTechLayerMinStepRule in _opendbpy:
_opendbpy.dbTechLayerMinStepRule_swigregister(dbTechLayerMinStepRule)
...
class dbTechLayerCornerSpacingRule(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    CONVEXCORNER = _opendbpy.dbTechLayerCornerSpacingRule_CONVEXCORNER
    CONCAVECORNER = _opendbpy.dbTechLayerCornerSpacingRule_CONCAVECORNER

    def setWithin(self, within):
        return _opendbpy.dbTechLayerCornerSpacingRule_setWithin(self, within)

    def getWithin(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getWithin(self)

    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerCornerSpacingRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getEolWidth(self)

    def setJogLength(self, jog_length):
        return _opendbpy.dbTechLayerCornerSpacingRule_setJogLength(self, jog_length)

    def getJogLength(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getJogLength(self)

    def setEdgeLength(self, edge_length):
        return _opendbpy.dbTechLayerCornerSpacingRule_setEdgeLength(self, edge_length)

    def getEdgeLength(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getEdgeLength(self)

    def setMinLength(self, min_length):
        return _opendbpy.dbTechLayerCornerSpacingRule_setMinLength(self, min_length)

    def getMinLength(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getMinLength(self)

    def setExceptNotchLength(self, except_notch_length):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptNotchLength(self, except_notch_length)

    def getExceptNotchLength(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getExceptNotchLength(self)

    def setSameMask(self, same_mask):
        return _opendbpy.dbTechLayerCornerSpacingRule_setSameMask(self, same_mask)

    def isSameMask(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isSameMask(self)

    def setCornerOnly(self, corner_only):
        return _opendbpy.dbTechLayerCornerSpacingRule_setCornerOnly(self, corner_only)

    def isCornerOnly(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isCornerOnly(self)

    def setExceptEol(self, except_eol):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptEol(self, except_eol)

    def isExceptEol(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptEol(self)

    def setExceptJogLength(self, except_jog_length):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptJogLength(self, except_jog_length)

    def isExceptJogLength(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptJogLength(self)

    def setEdgeLengthValid(self, edge_length_valid):
        return _opendbpy.dbTechLayerCornerSpacingRule_setEdgeLengthValid(self, edge_length_valid)

    def isEdgeLengthValid(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isEdgeLengthValid(self)

    def setIncludeShape(self, include_shape):
        return _opendbpy.dbTechLayerCornerSpacingRule_setIncludeShape(self, include_shape)

    def isIncludeShape(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isIncludeShape(self)

    def setMinLengthValid(self, min_length_valid):
        return _opendbpy.dbTechLayerCornerSpacingRule_setMinLengthValid(self, min_length_valid)

    def isMinLengthValid(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isMinLengthValid(self)

    def setExceptNotch(self, except_notch):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptNotch(self, except_notch)

    def isExceptNotch(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptNotch(self)

    def setExceptNotchLengthValid(self, except_notch_length_valid):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptNotchLengthValid(self, except_notch_length_valid)

    def isExceptNotchLengthValid(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptNotchLengthValid(self)

    def setExceptSameNet(self, except_same_net):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptSameNet(self, except_same_net)

    def isExceptSameNet(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptSameNet(self)

    def setExceptSameMetal(self, except_same_metal):
        return _opendbpy.dbTechLayerCornerSpacingRule_setExceptSameMetal(self, except_same_metal)

    def isExceptSameMetal(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isExceptSameMetal(self)

    def setCornerToCorner(self, corner_to_corner):
        return _opendbpy.dbTechLayerCornerSpacingRule_setCornerToCorner(self, corner_to_corner)

    def isCornerToCorner(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_isCornerToCorner(self)

    def setType(self, _type):
        return _opendbpy.dbTechLayerCornerSpacingRule_setType(self, _type)

    def getType(self):
        return _opendbpy.dbTechLayerCornerSpacingRule_getType(self)

    def addSpacing(self, width, spacing1, spacing2=0):
        return _opendbpy.dbTechLayerCornerSpacingRule_addSpacing(self, width, spacing1, spacing2)

    def getSpacingTable(self, tbl):
        return _opendbpy.dbTechLayerCornerSpacingRule_getSpacingTable(self, tbl)

    def getWidthTable(self, tbl):
        return _opendbpy.dbTechLayerCornerSpacingRule_getWidthTable(self, tbl)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerCornerSpacingRule_create(layer)

    @staticmethod
    def getTechLayerCornerSpacingRule(inly, dbid):
        return _opendbpy.dbTechLayerCornerSpacingRule_getTechLayerCornerSpacingRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCornerSpacingRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCornerSpacingRule_swiginit(self, _opendbpy.new_dbTechLayerCornerSpacingRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCornerSpacingRule

# Register dbTechLayerCornerSpacingRule in _opendbpy:
_opendbpy.dbTechLayerCornerSpacingRule_swigregister(dbTechLayerCornerSpacingRule)
...
class dbTechLayerSpacingTablePrlRule(object):
    ...
    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_getEolWidth(self)

    def setWrongDirection(self, wrong_direction):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setWrongDirection(self, wrong_direction)

    def isWrongDirection(self):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_isWrongDirection(self)

    def setSameMask(self, same_mask):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setSameMask(self, same_mask)

    def isSameMask(self):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_isSameMask(self)

    def setExceeptEol(self, exceept_eol):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setExceeptEol(self, exceept_eol)

    def isExceeptEol(self):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_isExceeptEol(self)

    @staticmethod
    def getTechLayerSpacingTablePrlRule(inly, dbid):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_getTechLayerSpacingTablePrlRule(inly, dbid)

    @staticmethod
    def create(_layer):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_create(_layer)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_destroy(rule)

    def setTable(self, width_tbl, length_tbl, spacing_tbl, excluded_map):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setTable(self, width_tbl, length_tbl, spacing_tbl, excluded_map)

    def getTable(self, width_tbl, length_tbl, spacing_tbl, excluded_map):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_getTable(self, width_tbl, length_tbl, spacing_tbl, excluded_map)

    def setSpacingTableInfluence(self, influence_tbl):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_setSpacingTableInfluence(self, influence_tbl)

    def getSpacing(self, width, length):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_getSpacing(self, width, length)

    def hasExceptWithin(self, width):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_hasExceptWithin(self, width)

    def getExceptWithin(self, width):
        return _opendbpy.dbTechLayerSpacingTablePrlRule_getExceptWithin(self, width)

    def __init__(self):
        _opendbpy.dbTechLayerSpacingTablePrlRule_swiginit(self, _opendbpy.new_dbTechLayerSpacingTablePrlRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerSpacingTablePrlRule

# Register dbTechLayerSpacingTablePrlRule in _opendbpy:
_opendbpy.dbTechLayerSpacingTablePrlRule_swigregister(dbTechLayerSpacingTablePrlRule)
...
class dbTechLayerEolKeepOutRule(object):
    ...
    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerEolKeepOutRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getEolWidth(self)

    def setBackwardExt(self, backward_ext):
        return _opendbpy.dbTechLayerEolKeepOutRule_setBackwardExt(self, backward_ext)

    def getBackwardExt(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getBackwardExt(self)

    def setForwardExt(self, forward_ext):
        return _opendbpy.dbTechLayerEolKeepOutRule_setForwardExt(self, forward_ext)

    def getForwardExt(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getForwardExt(self)

    def setSideExt(self, side_ext):
        return _opendbpy.dbTechLayerEolKeepOutRule_setSideExt(self, side_ext)

    def getSideExt(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getSideExt(self)

    def setWithinLow(self, within_low):
        return _opendbpy.dbTechLayerEolKeepOutRule_setWithinLow(self, within_low)

    def getWithinLow(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getWithinLow(self)

    def setWithinHigh(self, within_high):
        return _opendbpy.dbTechLayerEolKeepOutRule_setWithinHigh(self, within_high)

    def getWithinHigh(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getWithinHigh(self)

    def setClassName(self, class_name):
        return _opendbpy.dbTechLayerEolKeepOutRule_setClassName(self, class_name)

    def getClassName(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_getClassName(self)

    def setClassValid(self, class_valid):
        return _opendbpy.dbTechLayerEolKeepOutRule_setClassValid(self, class_valid)

    def isClassValid(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_isClassValid(self)

    def setCornerOnly(self, corner_only):
        return _opendbpy.dbTechLayerEolKeepOutRule_setCornerOnly(self, corner_only)

    def isCornerOnly(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_isCornerOnly(self)

    def setExceptWithin(self, except_within):
        return _opendbpy.dbTechLayerEolKeepOutRule_setExceptWithin(self, except_within)

    def isExceptWithin(self):
        return _opendbpy.dbTechLayerEolKeepOutRule_isExceptWithin(self)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerEolKeepOutRule_create(layer)

    @staticmethod
    def getTechLayerEolKeepOutRule(inly, dbid):
        return _opendbpy.dbTechLayerEolKeepOutRule_getTechLayerEolKeepOutRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerEolKeepOutRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerEolKeepOutRule_swiginit(self, _opendbpy.new_dbTechLayerEolKeepOutRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerEolKeepOutRule

# Register dbTechLayerEolKeepOutRule in _opendbpy:
_opendbpy.dbTechLayerEolKeepOutRule_swigregister(dbTechLayerEolKeepOutRule)
...
class dbTechLayerCutClassRule(object):
    ...
    def getName(self):
        return _opendbpy.dbTechLayerCutClassRule_getName(self)

    def setWidth(self, width):
        return _opendbpy.dbTechLayerCutClassRule_setWidth(self, width)

    def getWidth(self):
        return _opendbpy.dbTechLayerCutClassRule_getWidth(self)

    def setLength(self, length):
        return _opendbpy.dbTechLayerCutClassRule_setLength(self, length)

    def getLength(self):
        return _opendbpy.dbTechLayerCutClassRule_getLength(self)

    def setNumCuts(self, num_cuts):
        return _opendbpy.dbTechLayerCutClassRule_setNumCuts(self, num_cuts)

    def getNumCuts(self):
        return _opendbpy.dbTechLayerCutClassRule_getNumCuts(self)

    def setLengthValid(self, length_valid):
        return _opendbpy.dbTechLayerCutClassRule_setLengthValid(self, length_valid)

    def isLengthValid(self):
        return _opendbpy.dbTechLayerCutClassRule_isLengthValid(self)

    def setCutsValid(self, cuts_valid):
        return _opendbpy.dbTechLayerCutClassRule_setCutsValid(self, cuts_valid)

    def isCutsValid(self):
        return _opendbpy.dbTechLayerCutClassRule_isCutsValid(self)

    @staticmethod
    def getTechLayerCutClassRule(inly, dbid):
        return _opendbpy.dbTechLayerCutClassRule_getTechLayerCutClassRule(inly, dbid)

    @staticmethod
    def create(_layer, name):
        return _opendbpy.dbTechLayerCutClassRule_create(_layer, name)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCutClassRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCutClassRule_swiginit(self, _opendbpy.new_dbTechLayerCutClassRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCutClassRule

# Register dbTechLayerCutClassRule in _opendbpy:
_opendbpy.dbTechLayerCutClassRule_swigregister(dbTechLayerCutClassRule)
...
class dbTechLayerCutSpacingRule(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    NONE = _opendbpy.dbTechLayerCutSpacingRule_NONE
    MAXXY = _opendbpy.dbTechLayerCutSpacingRule_MAXXY
    SAMEMASK = _opendbpy.dbTechLayerCutSpacingRule_SAMEMASK
    LAYER = _opendbpy.dbTechLayerCutSpacingRule_LAYER
    ADJACENTCUTS = _opendbpy.dbTechLayerCutSpacingRule_ADJACENTCUTS
    PARALLELOVERLAP = _opendbpy.dbTechLayerCutSpacingRule_PARALLELOVERLAP
    PARALLELWITHIN = _opendbpy.dbTechLayerCutSpacingRule_PARALLELWITHIN
    SAMEMETALSHAREDEDGE = _opendbpy.dbTechLayerCutSpacingRule_SAMEMETALSHAREDEDGE
    AREA = _opendbpy.dbTechLayerCutSpacingRule_AREA

    def setCutSpacing(self, cut_spacing):
        return _opendbpy.dbTechLayerCutSpacingRule_setCutSpacing(self, cut_spacing)

    def getCutSpacing(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getCutSpacing(self)

    def setSecondLayer(self, second_layer):
        return _opendbpy.dbTechLayerCutSpacingRule_setSecondLayer(self, second_layer)

    def setOrthogonalSpacing(self, orthogonal_spacing):
        return _opendbpy.dbTechLayerCutSpacingRule_setOrthogonalSpacing(self, orthogonal_spacing)

    def getOrthogonalSpacing(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getOrthogonalSpacing(self)

    def setWidth(self, width):
        return _opendbpy.dbTechLayerCutSpacingRule_setWidth(self, width)

    def getWidth(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getWidth(self)

    def setEnclosure(self, enclosure):
        return _opendbpy.dbTechLayerCutSpacingRule_setEnclosure(self, enclosure)

    def getEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getEnclosure(self)

    def setEdgeLength(self, edge_length):
        return _opendbpy.dbTechLayerCutSpacingRule_setEdgeLength(self, edge_length)

    def getEdgeLength(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getEdgeLength(self)

    def setParWithin(self, par_within):
        return _opendbpy.dbTechLayerCutSpacingRule_setParWithin(self, par_within)

    def getParWithin(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getParWithin(self)

    def setParEnclosure(self, par_enclosure):
        return _opendbpy.dbTechLayerCutSpacingRule_setParEnclosure(self, par_enclosure)

    def getParEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getParEnclosure(self)

    def setEdgeEnclosure(self, edge_enclosure):
        return _opendbpy.dbTechLayerCutSpacingRule_setEdgeEnclosure(self, edge_enclosure)

    def getEdgeEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getEdgeEnclosure(self)

    def setAdjEnclosure(self, adj_enclosure):
        return _opendbpy.dbTechLayerCutSpacingRule_setAdjEnclosure(self, adj_enclosure)

    def getAdjEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getAdjEnclosure(self)

    def setAboveEnclosure(self, above_enclosure):
        return _opendbpy.dbTechLayerCutSpacingRule_setAboveEnclosure(self, above_enclosure)

    def getAboveEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getAboveEnclosure(self)

    def setAboveWidth(self, above_width):
        return _opendbpy.dbTechLayerCutSpacingRule_setAboveWidth(self, above_width)

    def getAboveWidth(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getAboveWidth(self)

    def setMinLength(self, min_length):
        return _opendbpy.dbTechLayerCutSpacingRule_setMinLength(self, min_length)

    def getMinLength(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getMinLength(self)

    def setExtension(self, extension):
        return _opendbpy.dbTechLayerCutSpacingRule_setExtension(self, extension)

    def getExtension(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getExtension(self)

    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerCutSpacingRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getEolWidth(self)

    def setNumCuts(self, num_cuts):
        return _opendbpy.dbTechLayerCutSpacingRule_setNumCuts(self, num_cuts)

    def getNumCuts(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getNumCuts(self)

    def setWithin(self, within):
        return _opendbpy.dbTechLayerCutSpacingRule_setWithin(self, within)

    def getWithin(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getWithin(self)

    def setSecondWithin(self, second_within):
        return _opendbpy.dbTechLayerCutSpacingRule_setSecondWithin(self, second_within)

    def getSecondWithin(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getSecondWithin(self)

    def setCutClass(self, cut_class):
        return _opendbpy.dbTechLayerCutSpacingRule_setCutClass(self, cut_class)

    def setTwoCuts(self, two_cuts):
        return _opendbpy.dbTechLayerCutSpacingRule_setTwoCuts(self, two_cuts)

    def getTwoCuts(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getTwoCuts(self)

    def setPrl(self, prl):
        return _opendbpy.dbTechLayerCutSpacingRule_setPrl(self, prl)

    def getPrl(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getPrl(self)

    def setParLength(self, par_length):
        return _opendbpy.dbTechLayerCutSpacingRule_setParLength(self, par_length)

    def getParLength(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getParLength(self)

    def setCutArea(self, cut_area):
        return _opendbpy.dbTechLayerCutSpacingRule_setCutArea(self, cut_area)

    def getCutArea(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getCutArea(self)

    def setCenterToCenter(self, center_to_center):
        return _opendbpy.dbTechLayerCutSpacingRule_setCenterToCenter(self, center_to_center)

    def isCenterToCenter(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isCenterToCenter(self)

    def setSameNet(self, same_net):
        return _opendbpy.dbTechLayerCutSpacingRule_setSameNet(self, same_net)

    def isSameNet(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSameNet(self)

    def setSameMetal(self, same_metal):
        return _opendbpy.dbTechLayerCutSpacingRule_setSameMetal(self, same_metal)

    def isSameMetal(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSameMetal(self)

    def setSameVia(self, same_via):
        return _opendbpy.dbTechLayerCutSpacingRule_setSameVia(self, same_via)

    def isSameVia(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSameVia(self)

    def setStack(self, stack):
        return _opendbpy.dbTechLayerCutSpacingRule_setStack(self, stack)

    def isStack(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isStack(self)

    def setOrthogonalSpacingValid(self, orthogonal_spacing_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setOrthogonalSpacingValid(self, orthogonal_spacing_valid)

    def isOrthogonalSpacingValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isOrthogonalSpacingValid(self)

    def setAboveWidthEnclosureValid(self, above_width_enclosure_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setAboveWidthEnclosureValid(self, above_width_enclosure_valid)

    def isAboveWidthEnclosureValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isAboveWidthEnclosureValid(self)

    def setShortEdgeOnly(self, short_edge_only):
        return _opendbpy.dbTechLayerCutSpacingRule_setShortEdgeOnly(self, short_edge_only)

    def isShortEdgeOnly(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isShortEdgeOnly(self)

    def setConcaveCornerWidth(self, concave_corner_width):
        return _opendbpy.dbTechLayerCutSpacingRule_setConcaveCornerWidth(self, concave_corner_width)

    def isConcaveCornerWidth(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isConcaveCornerWidth(self)

    def setConcaveCornerParallel(self, concave_corner_parallel):
        return _opendbpy.dbTechLayerCutSpacingRule_setConcaveCornerParallel(self, concave_corner_parallel)

    def isConcaveCornerParallel(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isConcaveCornerParallel(self)

    def setConcaveCornerEdgeLength(self, concave_corner_edge_length):
        return _opendbpy.dbTechLayerCutSpacingRule_setConcaveCornerEdgeLength(self, concave_corner_edge_length)

    def isConcaveCornerEdgeLength(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isConcaveCornerEdgeLength(self)

    def setConcaveCorner(self, concave_corner):
        return _opendbpy.dbTechLayerCutSpacingRule_setConcaveCorner(self, concave_corner)

    def isConcaveCorner(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isConcaveCorner(self)

    def setExtensionValid(self, extension_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setExtensionValid(self, extension_valid)

    def isExtensionValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExtensionValid(self)

    def setNonEolConvexCorner(self, non_eol_convex_corner):
        return _opendbpy.dbTechLayerCutSpacingRule_setNonEolConvexCorner(self, non_eol_convex_corner)

    def isNonEolConvexCorner(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isNonEolConvexCorner(self)

    def setEolWidthValid(self, eol_width_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setEolWidthValid(self, eol_width_valid)

    def isEolWidthValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isEolWidthValid(self)

    def setMinLengthValid(self, min_length_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setMinLengthValid(self, min_length_valid)

    def isMinLengthValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isMinLengthValid(self)

    def setAboveWidthValid(self, above_width_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setAboveWidthValid(self, above_width_valid)

    def isAboveWidthValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isAboveWidthValid(self)

    def setMaskOverlap(self, mask_overlap):
        return _opendbpy.dbTechLayerCutSpacingRule_setMaskOverlap(self, mask_overlap)

    def isMaskOverlap(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isMaskOverlap(self)

    def setWrongDirection(self, wrong_direction):
        return _opendbpy.dbTechLayerCutSpacingRule_setWrongDirection(self, wrong_direction)

    def isWrongDirection(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isWrongDirection(self)

    def setAdjacentCuts(self, adjacent_cuts):
        return _opendbpy.dbTechLayerCutSpacingRule_setAdjacentCuts(self, adjacent_cuts)

    def getAdjacentCuts(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getAdjacentCuts(self)

    def setExactAligned(self, exact_aligned):
        return _opendbpy.dbTechLayerCutSpacingRule_setExactAligned(self, exact_aligned)

    def isExactAligned(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExactAligned(self)

    def setCutClassToAll(self, cut_class_to_all):
        return _opendbpy.dbTechLayerCutSpacingRule_setCutClassToAll(self, cut_class_to_all)

    def isCutClassToAll(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isCutClassToAll(self)

    def setNoPrl(self, no_prl):
        return _opendbpy.dbTechLayerCutSpacingRule_setNoPrl(self, no_prl)

    def isNoPrl(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isNoPrl(self)

    def setSameMask(self, same_mask):
        return _opendbpy.dbTechLayerCutSpacingRule_setSameMask(self, same_mask)

    def isSameMask(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSameMask(self)

    def setExceptSamePgnet(self, except_same_pgnet):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptSamePgnet(self, except_same_pgnet)

    def isExceptSamePgnet(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptSamePgnet(self)

    def setSideParallelOverlap(self, side_parallel_overlap):
        return _opendbpy.dbTechLayerCutSpacingRule_setSideParallelOverlap(self, side_parallel_overlap)

    def isSideParallelOverlap(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSideParallelOverlap(self)

    def setExceptSameNet(self, except_same_net):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptSameNet(self, except_same_net)

    def isExceptSameNet(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptSameNet(self)

    def setExceptSameMetal(self, except_same_metal):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptSameMetal(self, except_same_metal)

    def isExceptSameMetal(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptSameMetal(self)

    def setExceptSameMetalOverlap(self, except_same_metal_overlap):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptSameMetalOverlap(self, except_same_metal_overlap)

    def isExceptSameMetalOverlap(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptSameMetalOverlap(self)

    def setExceptSameVia(self, except_same_via):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptSameVia(self, except_same_via)

    def isExceptSameVia(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptSameVia(self)

    def setAbove(self, above):
        return _opendbpy.dbTechLayerCutSpacingRule_setAbove(self, above)

    def isAbove(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isAbove(self)

    def setExceptTwoEdges(self, except_two_edges):
        return _opendbpy.dbTechLayerCutSpacingRule_setExceptTwoEdges(self, except_two_edges)

    def isExceptTwoEdges(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isExceptTwoEdges(self)

    def setTwoCutsValid(self, two_cuts_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setTwoCutsValid(self, two_cuts_valid)

    def isTwoCutsValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isTwoCutsValid(self)

    def setSameCut(self, same_cut):
        return _opendbpy.dbTechLayerCutSpacingRule_setSameCut(self, same_cut)

    def isSameCut(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isSameCut(self)

    def setLongEdgeOnly(self, long_edge_only):
        return _opendbpy.dbTechLayerCutSpacingRule_setLongEdgeOnly(self, long_edge_only)

    def isLongEdgeOnly(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isLongEdgeOnly(self)

    def setPrlValid(self, prl_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setPrlValid(self, prl_valid)

    def isPrlValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isPrlValid(self)

    def setBelow(self, below):
        return _opendbpy.dbTechLayerCutSpacingRule_setBelow(self, below)

    def isBelow(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isBelow(self)

    def setParWithinEnclosureValid(self, par_within_enclosure_valid):
        return _opendbpy.dbTechLayerCutSpacingRule_setParWithinEnclosureValid(self, par_within_enclosure_valid)

    def isParWithinEnclosureValid(self):
        return _opendbpy.dbTechLayerCutSpacingRule_isParWithinEnclosureValid(self)

    def getCutClass(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getCutClass(self)

    def getSecondLayer(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getSecondLayer(self)

    def getTechLayer(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getTechLayer(self)

    def setType(self, _type):
        return _opendbpy.dbTechLayerCutSpacingRule_setType(self, _type)

    def getType(self):
        return _opendbpy.dbTechLayerCutSpacingRule_getType(self)

    @staticmethod
    def getTechLayerCutSpacingRule(inly, dbid):
        return _opendbpy.dbTechLayerCutSpacingRule_getTechLayerCutSpacingRule(inly, dbid)

    @staticmethod
    def create(_layer):
        return _opendbpy.dbTechLayerCutSpacingRule_create(_layer)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCutSpacingRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCutSpacingRule_swiginit(self, _opendbpy.new_dbTechLayerCutSpacingRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCutSpacingRule

# Register dbTechLayerCutSpacingRule in _opendbpy:
_opendbpy.dbTechLayerCutSpacingRule_swigregister(dbTechLayerCutSpacingRule)
...
class dbTechLayerCutSpacingTableOrthRule(object):
    ...
    def getSpacingTable(self, tbl):
        return _opendbpy.dbTechLayerCutSpacingTableOrthRule_getSpacingTable(self, tbl)

    def setSpacingTable(self, tbl):
        return _opendbpy.dbTechLayerCutSpacingTableOrthRule_setSpacingTable(self, tbl)

    @staticmethod
    def create(parent):
        return _opendbpy.dbTechLayerCutSpacingTableOrthRule_create(parent)

    @staticmethod
    def getTechLayerCutSpacingTableOrthSubRule(parent, dbid):
        return _opendbpy.dbTechLayerCutSpacingTableOrthRule_getTechLayerCutSpacingTableOrthSubRule(parent, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCutSpacingTableOrthRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCutSpacingTableOrthRule_swiginit(self, _opendbpy.new_dbTechLayerCutSpacingTableOrthRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCutSpacingTableOrthRule

# Register dbTechLayerCutSpacingTableOrthRule in _opendbpy:
_opendbpy.dbTechLayerCutSpacingTableOrthRule_swigregister(dbTechLayerCutSpacingTableOrthRule)
...
class dbTechLayerCutSpacingTableDefRule(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    FIRST = _opendbpy.dbTechLayerCutSpacingTableDefRule_FIRST
    SECOND = _opendbpy.dbTechLayerCutSpacingTableDefRule_SECOND
    MAX = _opendbpy.dbTechLayerCutSpacingTableDefRule_MAX
    MIN = _opendbpy.dbTechLayerCutSpacingTableDefRule_MIN

    def setDefault(self, spacing):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setDefault(self, spacing)

    def getDefault(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getDefault(self)

    def setSecondLayer(self, second_layer):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSecondLayer(self, second_layer)

    def setPrl(self, prl):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setPrl(self, prl)

    def getPrl(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getPrl(self)

    def setExtension(self, extension):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setExtension(self, extension)

    def getExtension(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getExtension(self)

    def setDefaultValid(self, default_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setDefaultValid(self, default_valid)

    def isDefaultValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isDefaultValid(self)

    def setSameMask(self, same_mask):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSameMask(self, same_mask)

    def isSameMask(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isSameMask(self)

    def setSameNet(self, same_net):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSameNet(self, same_net)

    def isSameNet(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isSameNet(self)

    def setSameMetal(self, same_metal):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSameMetal(self, same_metal)

    def isSameMetal(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isSameMetal(self)

    def setSameVia(self, same_via):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSameVia(self, same_via)

    def isSameVia(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isSameVia(self)

    def setLayerValid(self, layer_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setLayerValid(self, layer_valid)

    def isLayerValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isLayerValid(self)

    def setNoStack(self, no_stack):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setNoStack(self, no_stack)

    def isNoStack(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isNoStack(self)

    def setNonZeroEnclosure(self, non_zero_enclosure):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setNonZeroEnclosure(self, non_zero_enclosure)

    def isNonZeroEnclosure(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isNonZeroEnclosure(self)

    def setPrlForAlignedCut(self, prl_for_aligned_cut):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setPrlForAlignedCut(self, prl_for_aligned_cut)

    def isPrlForAlignedCut(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isPrlForAlignedCut(self)

    def setCenterToCenterValid(self, center_to_center_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setCenterToCenterValid(self, center_to_center_valid)

    def isCenterToCenterValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isCenterToCenterValid(self)

    def setCenterAndEdgeValid(self, center_and_edge_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setCenterAndEdgeValid(self, center_and_edge_valid)

    def isCenterAndEdgeValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isCenterAndEdgeValid(self)

    def setNoPrl(self, no_prl):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setNoPrl(self, no_prl)

    def isNoPrl(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isNoPrl(self)

    def setPrlValid(self, prl_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setPrlValid(self, prl_valid)

    def isPrlValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isPrlValid(self)

    def setMaxXY(self, max_x_y):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setMaxXY(self, max_x_y)

    def isMaxXY(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isMaxXY(self)

    def setEndExtensionValid(self, end_extension_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setEndExtensionValid(self, end_extension_valid)

    def isEndExtensionValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isEndExtensionValid(self)

    def setSideExtensionValid(self, side_extension_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSideExtensionValid(self, side_extension_valid)

    def isSideExtensionValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isSideExtensionValid(self)

    def setExactAlignedSpacingValid(self, exact_aligned_spacing_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setExactAlignedSpacingValid(self, exact_aligned_spacing_valid)

    def isExactAlignedSpacingValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isExactAlignedSpacingValid(self)

    def setHorizontal(self, horizontal):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setHorizontal(self, horizontal)

    def isHorizontal(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isHorizontal(self)

    def setPrlHorizontal(self, prl_horizontal):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setPrlHorizontal(self, prl_horizontal)

    def isPrlHorizontal(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isPrlHorizontal(self)

    def setVertical(self, vertical):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setVertical(self, vertical)

    def isVertical(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isVertical(self)

    def setPrlVertical(self, prl_vertical):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setPrlVertical(self, prl_vertical)

    def isPrlVertical(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isPrlVertical(self)

    def setNonOppositeEnclosureSpacingValid(self, non_opposite_enclosure_spacing_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setNonOppositeEnclosureSpacingValid(self, non_opposite_enclosure_spacing_valid)

    def isNonOppositeEnclosureSpacingValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isNonOppositeEnclosureSpacingValid(self)

    def setOppositeEnclosureResizeSpacingValid(self, opposite_enclosure_resize_spacing_valid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setOppositeEnclosureResizeSpacingValid(self, opposite_enclosure_resize_spacing_valid)

    def isOppositeEnclosureResizeSpacingValid(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isOppositeEnclosureResizeSpacingValid(self)

    def addPrlForAlignedCutEntry(self, _from, to):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addPrlForAlignedCutEntry(self, _from, to)

    def addCenterToCenterEntry(self, _from, to):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addCenterToCenterEntry(self, _from, to)

    def addCenterAndEdgeEntry(self, _from, to):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addCenterAndEdgeEntry(self, _from, to)

    def addPrlEntry(self, _from, to, ccPrl):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addPrlEntry(self, _from, to, ccPrl)

    def addEndExtensionEntry(self, cls, ext):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addEndExtensionEntry(self, cls, ext)

    def addSideExtensionEntry(self, cls, ext):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addSideExtensionEntry(self, cls, ext)

    def addExactElignedEntry(self, cls, spacing):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addExactElignedEntry(self, cls, spacing)

    def addNonOppEncSpacingEntry(self, cls, spacing):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addNonOppEncSpacingEntry(self, cls, spacing)

    def addOppEncSpacingEntry(self, cls, rsz1, rsz2, spacing):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_addOppEncSpacingEntry(self, cls, rsz1, rsz2, spacing)

    def getSecondLayer(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getSecondLayer(self)

    def isCenterToCenter(self, cutClass1, cutClass2):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isCenterToCenter(self, cutClass1, cutClass2)

    def isCenterAndEdge(self, cutClass1, cutClass2):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isCenterAndEdge(self, cutClass1, cutClass2)

    def isPrlForAlignedCutClasses(self, cutClass1, cutClass2):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_isPrlForAlignedCutClasses(self, cutClass1, cutClass2)

    def getPrlEntry(self, cutClass1, cutClass2):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getPrlEntry(self, cutClass1, cutClass2)

    def setSpacingTable(self, table, row_map, col_map):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_setSpacingTable(self, table, row_map, col_map)

    def getSpacingTable(self, table, row_map, col_map):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getSpacingTable(self, table, row_map, col_map)

    def getExactAlignedSpacing(self, cutClass):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getExactAlignedSpacing(self, cutClass)

    def getMaxSpacing(self, *args):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getMaxSpacing(self, *args)

    def getSpacing(self, *args):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getSpacing(self, *args)

    def getTechLayer(self):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getTechLayer(self)

    @staticmethod
    def create(parent):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_create(parent)

    @staticmethod
    def getTechLayerCutSpacingTableDefSubRule(parent, dbid):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_getTechLayerCutSpacingTableDefSubRule(parent, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCutSpacingTableDefRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCutSpacingTableDefRule_swiginit(self, _opendbpy.new_dbTechLayerCutSpacingTableDefRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCutSpacingTableDefRule

# Register dbTechLayerCutSpacingTableDefRule in _opendbpy:
_opendbpy.dbTechLayerCutSpacingTableDefRule_swigregister(dbTechLayerCutSpacingTableDefRule)
...
class dbTechLayerCutEnclosureRule(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    DEFAULT = _opendbpy.dbTechLayerCutEnclosureRule_DEFAULT
    EOL = _opendbpy.dbTechLayerCutEnclosureRule_EOL
    ENDSIDE = _opendbpy.dbTechLayerCutEnclosureRule_ENDSIDE
    HORZ_AND_VERT = _opendbpy.dbTechLayerCutEnclosureRule_HORZ_AND_VERT

    def setCutClass(self, cut_class):
        return _opendbpy.dbTechLayerCutEnclosureRule_setCutClass(self, cut_class)

    def getCutClass(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getCutClass(self)

    def setEolWidth(self, eol_width):
        return _opendbpy.dbTechLayerCutEnclosureRule_setEolWidth(self, eol_width)

    def getEolWidth(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getEolWidth(self)

    def setEolMinLength(self, eol_min_length):
        return _opendbpy.dbTechLayerCutEnclosureRule_setEolMinLength(self, eol_min_length)

    def getEolMinLength(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getEolMinLength(self)

    def setFirstOverhang(self, first_overhang):
        return _opendbpy.dbTechLayerCutEnclosureRule_setFirstOverhang(self, first_overhang)

    def getFirstOverhang(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getFirstOverhang(self)

    def setSecondOverhang(self, second_overhang):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSecondOverhang(self, second_overhang)

    def getSecondOverhang(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getSecondOverhang(self)

    def setSpacing(self, spacing):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSpacing(self, spacing)

    def getSpacing(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getSpacing(self)

    def setExtension(self, extension):
        return _opendbpy.dbTechLayerCutEnclosureRule_setExtension(self, extension)

    def getExtension(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getExtension(self)

    def setForwardExtension(self, forward_extension):
        return _opendbpy.dbTechLayerCutEnclosureRule_setForwardExtension(self, forward_extension)

    def getForwardExtension(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getForwardExtension(self)

    def setBackwardExtension(self, backward_extension):
        return _opendbpy.dbTechLayerCutEnclosureRule_setBackwardExtension(self, backward_extension)

    def getBackwardExtension(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getBackwardExtension(self)

    def setMinWidth(self, min_width):
        return _opendbpy.dbTechLayerCutEnclosureRule_setMinWidth(self, min_width)

    def getMinWidth(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getMinWidth(self)

    def setCutWithin(self, cut_within):
        return _opendbpy.dbTechLayerCutEnclosureRule_setCutWithin(self, cut_within)

    def getCutWithin(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getCutWithin(self)

    def setMinLength(self, min_length):
        return _opendbpy.dbTechLayerCutEnclosureRule_setMinLength(self, min_length)

    def getMinLength(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getMinLength(self)

    def setParLength(self, par_length):
        return _opendbpy.dbTechLayerCutEnclosureRule_setParLength(self, par_length)

    def getParLength(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getParLength(self)

    def setSecondParLength(self, second_par_length):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSecondParLength(self, second_par_length)

    def getSecondParLength(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getSecondParLength(self)

    def setParWithin(self, par_within):
        return _opendbpy.dbTechLayerCutEnclosureRule_setParWithin(self, par_within)

    def getParWithin(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getParWithin(self)

    def setSecondParWithin(self, second_par_within):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSecondParWithin(self, second_par_within)

    def getSecondParWithin(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getSecondParWithin(self)

    def setBelowEnclosure(self, below_enclosure):
        return _opendbpy.dbTechLayerCutEnclosureRule_setBelowEnclosure(self, below_enclosure)

    def getBelowEnclosure(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getBelowEnclosure(self)

    def setNumCorners(self, num_corners):
        return _opendbpy.dbTechLayerCutEnclosureRule_setNumCorners(self, num_corners)

    def getNumCorners(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getNumCorners(self)

    def setCutClassValid(self, cut_class_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setCutClassValid(self, cut_class_valid)

    def isCutClassValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isCutClassValid(self)

    def setAbove(self, above):
        return _opendbpy.dbTechLayerCutEnclosureRule_setAbove(self, above)

    def isAbove(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isAbove(self)

    def setBelow(self, below):
        return _opendbpy.dbTechLayerCutEnclosureRule_setBelow(self, below)

    def isBelow(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isBelow(self)

    def setEolMinLengthValid(self, eol_min_length_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setEolMinLengthValid(self, eol_min_length_valid)

    def isEolMinLengthValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isEolMinLengthValid(self)

    def setEolOnly(self, eol_only):
        return _opendbpy.dbTechLayerCutEnclosureRule_setEolOnly(self, eol_only)

    def isEolOnly(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isEolOnly(self)

    def setShortEdgeOnly(self, short_edge_only):
        return _opendbpy.dbTechLayerCutEnclosureRule_setShortEdgeOnly(self, short_edge_only)

    def isShortEdgeOnly(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isShortEdgeOnly(self)

    def setSideSpacingValid(self, side_spacing_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSideSpacingValid(self, side_spacing_valid)

    def isSideSpacingValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isSideSpacingValid(self)

    def setEndSpacingValid(self, end_spacing_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setEndSpacingValid(self, end_spacing_valid)

    def isEndSpacingValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isEndSpacingValid(self)

    def setOffCenterLine(self, off_center_line):
        return _opendbpy.dbTechLayerCutEnclosureRule_setOffCenterLine(self, off_center_line)

    def isOffCenterLine(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isOffCenterLine(self)

    def setWidthValid(self, width_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setWidthValid(self, width_valid)

    def isWidthValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isWidthValid(self)

    def setIncludeAbutted(self, include_abutted):
        return _opendbpy.dbTechLayerCutEnclosureRule_setIncludeAbutted(self, include_abutted)

    def isIncludeAbutted(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isIncludeAbutted(self)

    def setExceptExtraCut(self, except_extra_cut):
        return _opendbpy.dbTechLayerCutEnclosureRule_setExceptExtraCut(self, except_extra_cut)

    def isExceptExtraCut(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isExceptExtraCut(self)

    def setPrl(self, prl):
        return _opendbpy.dbTechLayerCutEnclosureRule_setPrl(self, prl)

    def isPrl(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isPrl(self)

    def setNoSharedEdge(self, no_shared_edge):
        return _opendbpy.dbTechLayerCutEnclosureRule_setNoSharedEdge(self, no_shared_edge)

    def isNoSharedEdge(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isNoSharedEdge(self)

    def setLengthValid(self, length_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setLengthValid(self, length_valid)

    def isLengthValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isLengthValid(self)

    def setExtraCutValid(self, extra_cut_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setExtraCutValid(self, extra_cut_valid)

    def isExtraCutValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isExtraCutValid(self)

    def setExtraOnly(self, extra_only):
        return _opendbpy.dbTechLayerCutEnclosureRule_setExtraOnly(self, extra_only)

    def isExtraOnly(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isExtraOnly(self)

    def setRedundantCutValid(self, redundant_cut_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setRedundantCutValid(self, redundant_cut_valid)

    def isRedundantCutValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isRedundantCutValid(self)

    def setParallelValid(self, parallel_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setParallelValid(self, parallel_valid)

    def isParallelValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isParallelValid(self)

    def setSecondParallelValid(self, second_parallel_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSecondParallelValid(self, second_parallel_valid)

    def isSecondParallelValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isSecondParallelValid(self)

    def setSecondParWithinValid(self, second_par_within_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setSecondParWithinValid(self, second_par_within_valid)

    def isSecondParWithinValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isSecondParWithinValid(self)

    def setBelowEnclosureValid(self, below_enclosure_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setBelowEnclosureValid(self, below_enclosure_valid)

    def isBelowEnclosureValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isBelowEnclosureValid(self)

    def setConcaveCornersValid(self, concave_corners_valid):
        return _opendbpy.dbTechLayerCutEnclosureRule_setConcaveCornersValid(self, concave_corners_valid)

    def isConcaveCornersValid(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_isConcaveCornersValid(self)

    def setType(self, type):
        return _opendbpy.dbTechLayerCutEnclosureRule_setType(self, type)

    def getType(self):
        return _opendbpy.dbTechLayerCutEnclosureRule_getType(self)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerCutEnclosureRule_create(layer)

    @staticmethod
    def getTechLayerCutEnclosureRule(inly, dbid):
        return _opendbpy.dbTechLayerCutEnclosureRule_getTechLayerCutEnclosureRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerCutEnclosureRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerCutEnclosureRule_swiginit(self, _opendbpy.new_dbTechLayerCutEnclosureRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerCutEnclosureRule

# Register dbTechLayerCutEnclosureRule in _opendbpy:
_opendbpy.dbTechLayerCutEnclosureRule_swigregister(dbTechLayerCutEnclosureRule)
...
class dbTechLayerEolExtensionRule(object):
    ...
    def setSpacing(self, spacing):
        return _opendbpy.dbTechLayerEolExtensionRule_setSpacing(self, spacing)

    def getSpacing(self):
        return _opendbpy.dbTechLayerEolExtensionRule_getSpacing(self)

    def getExtensionTable(self, tbl):
        return _opendbpy.dbTechLayerEolExtensionRule_getExtensionTable(self, tbl)

    def setParallelOnly(self, parallel_only):
        return _opendbpy.dbTechLayerEolExtensionRule_setParallelOnly(self, parallel_only)

    def isParallelOnly(self):
        return _opendbpy.dbTechLayerEolExtensionRule_isParallelOnly(self)

    def addEntry(self, eol, ext):
        return _opendbpy.dbTechLayerEolExtensionRule_addEntry(self, eol, ext)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerEolExtensionRule_create(layer)

    @staticmethod
    def getTechLayerEolExtensionRule(inly, dbid):
        return _opendbpy.dbTechLayerEolExtensionRule_getTechLayerEolExtensionRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerEolExtensionRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerEolExtensionRule_swiginit(self, _opendbpy.new_dbTechLayerEolExtensionRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerEolExtensionRule

# Register dbTechLayerEolExtensionRule in _opendbpy:
_opendbpy.dbTechLayerEolExtensionRule_swigregister(dbTechLayerEolExtensionRule)
...
class dbTechLayerArraySpacingRule(object):
    ...
    def setViaWidth(self, via_width):
        return _opendbpy.dbTechLayerArraySpacingRule_setViaWidth(self, via_width)

    def getViaWidth(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getViaWidth(self)

    def setCutSpacing(self, cut_spacing):
        return _opendbpy.dbTechLayerArraySpacingRule_setCutSpacing(self, cut_spacing)

    def getCutSpacing(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getCutSpacing(self)

    def setWithin(self, within):
        return _opendbpy.dbTechLayerArraySpacingRule_setWithin(self, within)

    def getWithin(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getWithin(self)

    def setArrayWidth(self, array_width):
        return _opendbpy.dbTechLayerArraySpacingRule_setArrayWidth(self, array_width)

    def getArrayWidth(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getArrayWidth(self)

    def setCutClass(self, cut_class):
        return _opendbpy.dbTechLayerArraySpacingRule_setCutClass(self, cut_class)

    def setParallelOverlap(self, parallel_overlap):
        return _opendbpy.dbTechLayerArraySpacingRule_setParallelOverlap(self, parallel_overlap)

    def isParallelOverlap(self):
        return _opendbpy.dbTechLayerArraySpacingRule_isParallelOverlap(self)

    def setLongArray(self, long_array):
        return _opendbpy.dbTechLayerArraySpacingRule_setLongArray(self, long_array)

    def isLongArray(self):
        return _opendbpy.dbTechLayerArraySpacingRule_isLongArray(self)

    def setViaWidthValid(self, via_width_valid):
        return _opendbpy.dbTechLayerArraySpacingRule_setViaWidthValid(self, via_width_valid)

    def isViaWidthValid(self):
        return _opendbpy.dbTechLayerArraySpacingRule_isViaWidthValid(self)

    def setWithinValid(self, within_valid):
        return _opendbpy.dbTechLayerArraySpacingRule_setWithinValid(self, within_valid)

    def isWithinValid(self):
        return _opendbpy.dbTechLayerArraySpacingRule_isWithinValid(self)

    def setCutsArraySpacing(self, num_cuts, spacing):
        return _opendbpy.dbTechLayerArraySpacingRule_setCutsArraySpacing(self, num_cuts, spacing)

    def getCutsArraySpacing(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getCutsArraySpacing(self)

    def getCutClass(self):
        return _opendbpy.dbTechLayerArraySpacingRule_getCutClass(self)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerArraySpacingRule_create(layer)

    @staticmethod
    def getTechLayerArraySpacingRule(inly, dbid):
        return _opendbpy.dbTechLayerArraySpacingRule_getTechLayerArraySpacingRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerArraySpacingRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerArraySpacingRule_swiginit(self, _opendbpy.new_dbTechLayerArraySpacingRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerArraySpacingRule

# Register dbTechLayerArraySpacingRule in _opendbpy:
_opendbpy.dbTechLayerArraySpacingRule_swigregister(dbTechLayerArraySpacingRule)
...
class dbTechLayerWidthTableRule(object):
    ...
    def setWrongDirection(self, wrong_direction):
        return _opendbpy.dbTechLayerWidthTableRule_setWrongDirection(self, wrong_direction)

    def isWrongDirection(self):
        return _opendbpy.dbTechLayerWidthTableRule_isWrongDirection(self)

    def setOrthogonal(self, orthogonal):
        return _opendbpy.dbTechLayerWidthTableRule_setOrthogonal(self, orthogonal)

    def isOrthogonal(self):
        return _opendbpy.dbTechLayerWidthTableRule_isOrthogonal(self)

    def addWidth(self, width):
        return _opendbpy.dbTechLayerWidthTableRule_addWidth(self, width)

    def getWidthTable(self):
        return _opendbpy.dbTechLayerWidthTableRule_getWidthTable(self)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerWidthTableRule_create(layer)

    @staticmethod
    def getTechLayerWidthTableRule(inly, dbid):
        return _opendbpy.dbTechLayerWidthTableRule_getTechLayerWidthTableRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerWidthTableRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerWidthTableRule_swiginit(self, _opendbpy.new_dbTechLayerWidthTableRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerWidthTableRule

# Register dbTechLayerWidthTableRule in _opendbpy:
_opendbpy.dbTechLayerWidthTableRule_swigregister(dbTechLayerWidthTableRule)
...
class dbTechLayerMinCutRule(object):
    ...
    def setNumCuts(self, num_cuts):
        return _opendbpy.dbTechLayerMinCutRule_setNumCuts(self, num_cuts)

    def getNumCuts(self):
        return _opendbpy.dbTechLayerMinCutRule_getNumCuts(self)

    def getCutClassCutsMap(self):
        return _opendbpy.dbTechLayerMinCutRule_getCutClassCutsMap(self)

    def setWidth(self, width):
        return _opendbpy.dbTechLayerMinCutRule_setWidth(self, width)

    def getWidth(self):
        return _opendbpy.dbTechLayerMinCutRule_getWidth(self)

    def setWithinCutDist(self, within_cut_dist):
        return _opendbpy.dbTechLayerMinCutRule_setWithinCutDist(self, within_cut_dist)

    def getWithinCutDist(self):
        return _opendbpy.dbTechLayerMinCutRule_getWithinCutDist(self)

    def setLength(self, length):
        return _opendbpy.dbTechLayerMinCutRule_setLength(self, length)

    def getLength(self):
        return _opendbpy.dbTechLayerMinCutRule_getLength(self)

    def setLengthWithinDist(self, length_within_dist):
        return _opendbpy.dbTechLayerMinCutRule_setLengthWithinDist(self, length_within_dist)

    def getLengthWithinDist(self):
        return _opendbpy.dbTechLayerMinCutRule_getLengthWithinDist(self)

    def setArea(self, area):
        return _opendbpy.dbTechLayerMinCutRule_setArea(self, area)

    def getArea(self):
        return _opendbpy.dbTechLayerMinCutRule_getArea(self)

    def setAreaWithinDist(self, area_within_dist):
        return _opendbpy.dbTechLayerMinCutRule_setAreaWithinDist(self, area_within_dist)

    def getAreaWithinDist(self):
        return _opendbpy.dbTechLayerMinCutRule_getAreaWithinDist(self)

    def setPerCutClass(self, per_cut_class):
        return _opendbpy.dbTechLayerMinCutRule_setPerCutClass(self, per_cut_class)

    def isPerCutClass(self):
        return _opendbpy.dbTechLayerMinCutRule_isPerCutClass(self)

    def setWithinCutDistValid(self, within_cut_dist_valid):
        return _opendbpy.dbTechLayerMinCutRule_setWithinCutDistValid(self, within_cut_dist_valid)

    def isWithinCutDistValid(self):
        return _opendbpy.dbTechLayerMinCutRule_isWithinCutDistValid(self)

    def setFromAbove(self, from_above):
        return _opendbpy.dbTechLayerMinCutRule_setFromAbove(self, from_above)

    def isFromAbove(self):
        return _opendbpy.dbTechLayerMinCutRule_isFromAbove(self)

    def setFromBelow(self, from_below):
        return _opendbpy.dbTechLayerMinCutRule_setFromBelow(self, from_below)

    def isFromBelow(self):
        return _opendbpy.dbTechLayerMinCutRule_isFromBelow(self)

    def setLengthValid(self, length_valid):
        return _opendbpy.dbTechLayerMinCutRule_setLengthValid(self, length_valid)

    def isLengthValid(self):
        return _opendbpy.dbTechLayerMinCutRule_isLengthValid(self)

    def setAreaValid(self, area_valid):
        return _opendbpy.dbTechLayerMinCutRule_setAreaValid(self, area_valid)

    def isAreaValid(self):
        return _opendbpy.dbTechLayerMinCutRule_isAreaValid(self)

    def setAreaWithinDistValid(self, area_within_dist_valid):
        return _opendbpy.dbTechLayerMinCutRule_setAreaWithinDistValid(self, area_within_dist_valid)

    def isAreaWithinDistValid(self):
        return _opendbpy.dbTechLayerMinCutRule_isAreaWithinDistValid(self)

    def setSameMetalOverlap(self, same_metal_overlap):
        return _opendbpy.dbTechLayerMinCutRule_setSameMetalOverlap(self, same_metal_overlap)

    def isSameMetalOverlap(self):
        return _opendbpy.dbTechLayerMinCutRule_isSameMetalOverlap(self)

    def setFullyEnclosed(self, fully_enclosed):
        return _opendbpy.dbTechLayerMinCutRule_setFullyEnclosed(self, fully_enclosed)

    def isFullyEnclosed(self):
        return _opendbpy.dbTechLayerMinCutRule_isFullyEnclosed(self)

    def setCutsPerCutClass(self, cut_class, num_cuts):
        return _opendbpy.dbTechLayerMinCutRule_setCutsPerCutClass(self, cut_class, num_cuts)

    @staticmethod
    def create(layer):
        return _opendbpy.dbTechLayerMinCutRule_create(layer)

    @staticmethod
    def getTechLayerMinCutRule(inly, dbid):
        return _opendbpy.dbTechLayerMinCutRule_getTechLayerMinCutRule(inly, dbid)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerMinCutRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerMinCutRule_swiginit(self, _opendbpy.new_dbTechLayerMinCutRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerMinCutRule

# Register dbTechLayerMinCutRule in _opendbpy:
_opendbpy.dbTechLayerMinCutRule_swigregister(dbTechLayerMinCutRule)
...
class dbGuide(object):
    ...
    def getBox(self):
        return _opendbpy.dbGuide_getBox(self)

    def getNet(self):
        return _opendbpy.dbGuide_getNet(self)

    def getLayer(self):
        return _opendbpy.dbGuide_getLayer(self)

    @staticmethod
    def create(net, layer, box):
        return _opendbpy.dbGuide_create(net, layer, box)

    @staticmethod
    def getGuide(block, dbid):
        return _opendbpy.dbGuide_getGuide(block, dbid)

    @staticmethod
    def destroy(guide):
        return _opendbpy.dbGuide_destroy(guide)

    def __init__(self):
        _opendbpy.dbGuide_swiginit(self, _opendbpy.new_dbGuide())
    __swig_destroy__ = _opendbpy.delete_dbGuide

# Register dbGuide in _opendbpy:
_opendbpy.dbGuide_swigregister(dbGuide)
...
class dbMetalWidthViaMap(object):
    ...
    def setViaCutClass(self, via_cut_class):
        return _opendbpy.dbMetalWidthViaMap_setViaCutClass(self, via_cut_class)

    def isViaCutClass(self):
        return _opendbpy.dbMetalWidthViaMap_isViaCutClass(self)

    def setCutLayer(self, cut_layer):
        return _opendbpy.dbMetalWidthViaMap_setCutLayer(self, cut_layer)

    def setBelowLayerWidthLow(self, below_layer_width_low):
        return _opendbpy.dbMetalWidthViaMap_setBelowLayerWidthLow(self, below_layer_width_low)

    def getBelowLayerWidthLow(self):
        return _opendbpy.dbMetalWidthViaMap_getBelowLayerWidthLow(self)

    def setBelowLayerWidthHigh(self, below_layer_width_high):
        return _opendbpy.dbMetalWidthViaMap_setBelowLayerWidthHigh(self, below_layer_width_high)

    def getBelowLayerWidthHigh(self):
        return _opendbpy.dbMetalWidthViaMap_getBelowLayerWidthHigh(self)

    def setAboveLayerWidthLow(self, above_layer_width_low):
        return _opendbpy.dbMetalWidthViaMap_setAboveLayerWidthLow(self, above_layer_width_low)

    def getAboveLayerWidthLow(self):
        return _opendbpy.dbMetalWidthViaMap_getAboveLayerWidthLow(self)

    def setAboveLayerWidthHigh(self, above_layer_width_high):
        return _opendbpy.dbMetalWidthViaMap_setAboveLayerWidthHigh(self, above_layer_width_high)

    def getAboveLayerWidthHigh(self):
        return _opendbpy.dbMetalWidthViaMap_getAboveLayerWidthHigh(self)

    def setViaName(self, via_name):
        return _opendbpy.dbMetalWidthViaMap_setViaName(self, via_name)

    def getViaName(self):
        return _opendbpy.dbMetalWidthViaMap_getViaName(self)

    def setPgVia(self, pg_via):
        return _opendbpy.dbMetalWidthViaMap_setPgVia(self, pg_via)

    def isPgVia(self):
        return _opendbpy.dbMetalWidthViaMap_isPgVia(self)

    def getCutLayer(self):
        return _opendbpy.dbMetalWidthViaMap_getCutLayer(self)

    @staticmethod
    def create(tech):
        return _opendbpy.dbMetalWidthViaMap_create(tech)

    @staticmethod
    def destroy(via_map):
        return _opendbpy.dbMetalWidthViaMap_destroy(via_map)

    @staticmethod
    def getMetalWidthViaMap(tech, dbid):
        return _opendbpy.dbMetalWidthViaMap_getMetalWidthViaMap(tech, dbid)

    def __init__(self):
        _opendbpy.dbMetalWidthViaMap_swiginit(self, _opendbpy.new_dbMetalWidthViaMap())
    __swig_destroy__ = _opendbpy.delete_dbMetalWidthViaMap

# Register dbMetalWidthViaMap in _opendbpy:
_opendbpy.dbMetalWidthViaMap_swigregister(dbMetalWidthViaMap)
...
class dbTechLayerAreaRule(object):
    ...
    def setArea(self, area):
        return _opendbpy.dbTechLayerAreaRule_setArea(self, area)

    def getArea(self):
        return _opendbpy.dbTechLayerAreaRule_getArea(self)

    def setExceptMinWidth(self, except_min_width):
        return _opendbpy.dbTechLayerAreaRule_setExceptMinWidth(self, except_min_width)

    def getExceptMinWidth(self):
        return _opendbpy.dbTechLayerAreaRule_getExceptMinWidth(self)

    def setExceptEdgeLength(self, except_edge_length):
        return _opendbpy.dbTechLayerAreaRule_setExceptEdgeLength(self, except_edge_length)

    def getExceptEdgeLength(self):
        return _opendbpy.dbTechLayerAreaRule_getExceptEdgeLength(self)

    def setExceptEdgeLengths(self, except_edge_lengths):
        return _opendbpy.dbTechLayerAreaRule_setExceptEdgeLengths(self, except_edge_lengths)

    def getExceptEdgeLengths(self):
        return _opendbpy.dbTechLayerAreaRule_getExceptEdgeLengths(self)

    def setExceptMinSize(self, except_min_size):
        return _opendbpy.dbTechLayerAreaRule_setExceptMinSize(self, except_min_size)

    def getExceptMinSize(self):
        return _opendbpy.dbTechLayerAreaRule_getExceptMinSize(self)

    def setExceptStep(self, except_step):
        return _opendbpy.dbTechLayerAreaRule_setExceptStep(self, except_step)

    def getExceptStep(self):
        return _opendbpy.dbTechLayerAreaRule_getExceptStep(self)

    def setMask(self, mask):
        return _opendbpy.dbTechLayerAreaRule_setMask(self, mask)

    def getMask(self):
        return _opendbpy.dbTechLayerAreaRule_getMask(self)

    def setRectWidth(self, rect_width):
        return _opendbpy.dbTechLayerAreaRule_setRectWidth(self, rect_width)

    def getRectWidth(self):
        return _opendbpy.dbTechLayerAreaRule_getRectWidth(self)

    def setExceptRectangle(self, except_rectangle):
        return _opendbpy.dbTechLayerAreaRule_setExceptRectangle(self, except_rectangle)

    def isExceptRectangle(self):
        return _opendbpy.dbTechLayerAreaRule_isExceptRectangle(self)

    def setOverlap(self, overlap):
        return _opendbpy.dbTechLayerAreaRule_setOverlap(self, overlap)

    def getOverlap(self):
        return _opendbpy.dbTechLayerAreaRule_getOverlap(self)

    @staticmethod
    def create(_layer):
        return _opendbpy.dbTechLayerAreaRule_create(_layer)

    def setTrimLayer(self, trim_layer):
        return _opendbpy.dbTechLayerAreaRule_setTrimLayer(self, trim_layer)

    def getTrimLayer(self):
        return _opendbpy.dbTechLayerAreaRule_getTrimLayer(self)

    @staticmethod
    def destroy(rule):
        return _opendbpy.dbTechLayerAreaRule_destroy(rule)

    def __init__(self):
        _opendbpy.dbTechLayerAreaRule_swiginit(self, _opendbpy.new_dbTechLayerAreaRule())
    __swig_destroy__ = _opendbpy.delete_dbTechLayerAreaRule

# Register dbTechLayerAreaRule in _opendbpy:
_opendbpy.dbTechLayerAreaRule_swigregister(dbTechLayerAreaRule)
...
class dbModule(object):
    ...
    def getLeafInsts(self):
        return _opendbpy.dbModule_getLeafInsts(self)
    ...
    def getHierarchicalName(self):
        return _opendbpy.dbModule_getHierarchicalName(self)
...
class dbModInst(object):
    ...
    def getHierarchicalName(self):
        return _opendbpy.dbModInst_getHierarchicalName(self)
...
class dbGroup(object):
    ...
    def getRegion(self):
        return _opendbpy.dbGroup_getRegion(self)

    def setType(self, type):
        return _opendbpy.dbGroup_setType(self, type)
...
class dbGCellGrid(object):
    ...
    def getGridX(self):
        return _opendbpy.dbGCellGrid_getGridX(self)

    def getGridY(self):
        return _opendbpy.dbGCellGrid_getGridY(self)
    ...
    def getGridPatternX(self, i):
        return _opendbpy.dbGCellGrid_getGridPatternX(self, i)

    def getGridPatternY(self, i):
        return _opendbpy.dbGCellGrid_getGridPatternY(self, i)
...
class dbAccessPoint(object):
    ...
    def setPoint(self, point):
        return _opendbpy.dbAccessPoint_setPoint(self, point)

    def getPoint(self):
        return _opendbpy.dbAccessPoint_getPoint(self)

    def setLayer(self, layer):
        return _opendbpy.dbAccessPoint_setLayer(self, layer)

    def setAccesses(self, accesses):
        return _opendbpy.dbAccessPoint_setAccesses(self, accesses)

    def getAccesses(self, tbl):
        return _opendbpy.dbAccessPoint_getAccesses(self, tbl)

    def setLowType(self, type_low):
        return _opendbpy.dbAccessPoint_setLowType(self, type_low)

    def getLowType(self):
        return _opendbpy.dbAccessPoint_getLowType(self)

    def setHighType(self, type_high):
        return _opendbpy.dbAccessPoint_setHighType(self, type_high)

    def getHighType(self):
        return _opendbpy.dbAccessPoint_getHighType(self)

    def setAccess(self, access, dir):
        return _opendbpy.dbAccessPoint_setAccess(self, access, dir)

    def hasAccess(self, *args):
        return _opendbpy.dbAccessPoint_hasAccess(self, *args)

    def getLayer(self):
        return _opendbpy.dbAccessPoint_getLayer(self)

    def getMPin(self):
        return _opendbpy.dbAccessPoint_getMPin(self)

    def getBPin(self):
        return _opendbpy.dbAccessPoint_getBPin(self)

    def getVias(self):
        return _opendbpy.dbAccessPoint_getVias(self)

    def addTechVia(self, num_cuts, via):
        return _opendbpy.dbAccessPoint_addTechVia(self, num_cuts, via)

    def addBlockVia(self, num_cuts, via):
        return _opendbpy.dbAccessPoint_addBlockVia(self, num_cuts, via)

    def addSegment(self, segment, begin_style_trunc, end_style_trunc):
        return _opendbpy.dbAccessPoint_addSegment(self, segment, begin_style_trunc, end_style_trunc)

    def getSegments(self):
        return _opendbpy.dbAccessPoint_getSegments(self)

    @staticmethod
    def create(*args):
        return _opendbpy.dbAccessPoint_create(*args)

    @staticmethod
    def getAccessPoint(block, dbid):
        return _opendbpy.dbAccessPoint_getAccessPoint(block, dbid)

    @staticmethod
    def destroy(ap):
        return _opendbpy.dbAccessPoint_destroy(ap)

    def __init__(self):
        _opendbpy.dbAccessPoint_swiginit(self, _opendbpy.new_dbAccessPoint())
    __swig_destroy__ = _opendbpy.delete_dbAccessPoint

# Register dbAccessPoint in _opendbpy:
_opendbpy.dbAccessPoint_swigregister(dbAccessPoint)
...
class dbGlobalConnect(object):
    ...
    def getRegion(self):
        return _opendbpy.dbGlobalConnect_getRegion(self)

    def getNet(self):
        return _opendbpy.dbGlobalConnect_getNet(self)

    def getInstPattern(self):
        return _opendbpy.dbGlobalConnect_getInstPattern(self)

    def getPinPattern(self):
        return _opendbpy.dbGlobalConnect_getPinPattern(self)

    def getInsts(self):
        return _opendbpy.dbGlobalConnect_getInsts(self)

    def connect(self, inst):
        return _opendbpy.dbGlobalConnect_connect(self, inst)

    @staticmethod
    def create(net, region, inst_pattern, pin_pattern):
        return _opendbpy.dbGlobalConnect_create(net, region, inst_pattern, pin_pattern)

    @staticmethod
    def destroy(global_connect):
        return _opendbpy.dbGlobalConnect_destroy(global_connect)

    def __init__(self):
        _opendbpy.dbGlobalConnect_swiginit(self, _opendbpy.new_dbGlobalConnect())
    __swig_destroy__ = _opendbpy.delete_dbGlobalConnect

# Register dbGlobalConnect in _opendbpy:
_opendbpy.dbGlobalConnect_swigregister(dbGlobalConnect)
...
class dbPowerDomain(object):
    ...
    def getName(self):
        return _opendbpy.dbPowerDomain_getName(self)

    def getGroup(self):
        return _opendbpy.dbPowerDomain_getGroup(self)

    def setTop(self, top):
        return _opendbpy.dbPowerDomain_setTop(self, top)

    def isTop(self):
        return _opendbpy.dbPowerDomain_isTop(self)

    def setParent(self, parent):
        return _opendbpy.dbPowerDomain_setParent(self, parent)

    def getParent(self):
        return _opendbpy.dbPowerDomain_getParent(self)

    def setGroup(self, group):
        return _opendbpy.dbPowerDomain_setGroup(self, group)

    @staticmethod
    def create(block, name):
        return _opendbpy.dbPowerDomain_create(block, name)

    @staticmethod
    def destroy(pd):
        return _opendbpy.dbPowerDomain_destroy(pd)

    def addElement(self, element):
        return _opendbpy.dbPowerDomain_addElement(self, element)

    def getElements(self):
        return _opendbpy.dbPowerDomain_getElements(self)

    def addPowerSwitch(self, ps):
        return _opendbpy.dbPowerDomain_addPowerSwitch(self, ps)

    def addIsolation(self, iso):
        return _opendbpy.dbPowerDomain_addIsolation(self, iso)

    def getPowerSwitches(self):
        return _opendbpy.dbPowerDomain_getPowerSwitches(self)

    def getIsolations(self):
        return _opendbpy.dbPowerDomain_getIsolations(self)

    def setArea(self, x1, y1, x2, y2):
        return _opendbpy.dbPowerDomain_setArea(self, x1, y1, x2, y2)

    def getArea(self, x1, y1, x2, y2):
        return _opendbpy.dbPowerDomain_getArea(self, x1, y1, x2, y2)

    def __init__(self):
        _opendbpy.dbPowerDomain_swiginit(self, _opendbpy.new_dbPowerDomain())
    __swig_destroy__ = _opendbpy.delete_dbPowerDomain

# Register dbPowerDomain in _opendbpy:
_opendbpy.dbPowerDomain_swigregister(dbPowerDomain)
...
class dbLogicPort(object):
    ...
    def getName(self):
        return _opendbpy.dbLogicPort_getName(self)

    def getDirection(self):
        return _opendbpy.dbLogicPort_getDirection(self)

    @staticmethod
    def create(block, name, direction):
        return _opendbpy.dbLogicPort_create(block, name, direction)

    @staticmethod
    def destroy(lp):
        return _opendbpy.dbLogicPort_destroy(lp)

    def __init__(self):
        _opendbpy.dbLogicPort_swiginit(self, _opendbpy.new_dbLogicPort())
    __swig_destroy__ = _opendbpy.delete_dbLogicPort

# Register dbLogicPort in _opendbpy:
_opendbpy.dbLogicPort_swigregister(dbLogicPort)
...
class dbPowerSwitch(object):
    ...
    def getName(self):
        return _opendbpy.dbPowerSwitch_getName(self)

    def getInSupplyPort(self):
        return _opendbpy.dbPowerSwitch_getInSupplyPort(self)

    def getOutSupplyPort(self):
        return _opendbpy.dbPowerSwitch_getOutSupplyPort(self)

    def setControlNet(self, control_net):
        return _opendbpy.dbPowerSwitch_setControlNet(self, control_net)

    def getControlNet(self):
        return _opendbpy.dbPowerSwitch_getControlNet(self)

    def setPowerDomain(self, power_domain):
        return _opendbpy.dbPowerSwitch_setPowerDomain(self, power_domain)

    def getPowerDomain(self):
        return _opendbpy.dbPowerSwitch_getPowerDomain(self)

    @staticmethod
    def create(block, name):
        return _opendbpy.dbPowerSwitch_create(block, name)

    @staticmethod
    def destroy(ps):
        return _opendbpy.dbPowerSwitch_destroy(ps)

    def setInSupplyPort(self, in_port):
        return _opendbpy.dbPowerSwitch_setInSupplyPort(self, in_port)

    def setOutSupplyPort(self, out_port):
        return _opendbpy.dbPowerSwitch_setOutSupplyPort(self, out_port)

    def addControlPort(self, control_port):
        return _opendbpy.dbPowerSwitch_addControlPort(self, control_port)

    def addOnState(self, on_state):
        return _opendbpy.dbPowerSwitch_addOnState(self, on_state)

    def getControlPorts(self):
        return _opendbpy.dbPowerSwitch_getControlPorts(self)

    def getOnStates(self):
        return _opendbpy.dbPowerSwitch_getOnStates(self)

    def __init__(self):
        _opendbpy.dbPowerSwitch_swiginit(self, _opendbpy.new_dbPowerSwitch())
    __swig_destroy__ = _opendbpy.delete_dbPowerSwitch

# Register dbPowerSwitch in _opendbpy:
_opendbpy.dbPowerSwitch_swigregister(dbPowerSwitch)
...
class dbIsolation(object):
    ...
    def getName(self):
        return _opendbpy.dbIsolation_getName(self)

    def getAppliesTo(self):
        return _opendbpy.dbIsolation_getAppliesTo(self)

    def getClampValue(self):
        return _opendbpy.dbIsolation_getClampValue(self)

    def getIsolationSignal(self):
        return _opendbpy.dbIsolation_getIsolationSignal(self)

    def getIsolationSense(self):
        return _opendbpy.dbIsolation_getIsolationSense(self)

    def getLocation(self):
        return _opendbpy.dbIsolation_getLocation(self)

    def setPowerDomain(self, power_domain):
        return _opendbpy.dbIsolation_setPowerDomain(self, power_domain)

    def getPowerDomain(self):
        return _opendbpy.dbIsolation_getPowerDomain(self)

    @staticmethod
    def create(block, name):
        return _opendbpy.dbIsolation_create(block, name)

    @staticmethod
    def destroy(iso):
        return _opendbpy.dbIsolation_destroy(iso)

    def setAppliesTo(self, applies_to):
        return _opendbpy.dbIsolation_setAppliesTo(self, applies_to)

    def setClampValue(self, clamp_value):
        return _opendbpy.dbIsolation_setClampValue(self, clamp_value)

    def setIsolationSignal(self, isolation_signal):
        return _opendbpy.dbIsolation_setIsolationSignal(self, isolation_signal)

    def setIsolationSense(self, isolation_sense):
        return _opendbpy.dbIsolation_setIsolationSense(self, isolation_sense)

    def setLocation(self, location):
        return _opendbpy.dbIsolation_setLocation(self, location)

    def addIsolationCell(self, master):
        return _opendbpy.dbIsolation_addIsolationCell(self, master)

    def getIsolationCells(self):
        return _opendbpy.dbIsolation_getIsolationCells(self)

    def __init__(self):
        _opendbpy.dbIsolation_swiginit(self, _opendbpy.new_dbIsolation())
    __swig_destroy__ = _opendbpy.delete_dbIsolation

# Register dbIsolation in _opendbpy:
_opendbpy.dbIsolation_swigregister(dbIsolation)
...
def dumpAPs(block, file_name):
    return _opendbpy.dumpAPs(block, file_name)
...
class dbBlockCallBackObj(object):
    ...
    def inDbRegionAddBox(self, arg2, arg3):
        return _opendbpy.dbBlockCallBackObj_inDbRegionAddBox(self, arg2, arg3)
    ...
    def inDbSWireAddSBox(self, arg2):
        return _opendbpy.dbBlockCallBackObj_inDbSWireAddSBox(self, arg2)

    def inDbSWireRemoveSBox(self, arg2):
        return _opendbpy.dbBlockCallBackObj_inDbSWireRemoveSBox(self, arg2)
